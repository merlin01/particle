...
THREE.Vector3.prototype = {constructor: THREE.Vector3, set: function(a, b, c) {
    ...
    setLength: function(a) {
        ...
        var c = b ? b.x : 1, d = b ? b.y : 1, e = b ? b.z : 1, f = a.elements[0] / c, g = a.elements[4] / d, c = a.elements[1] / c, d = a.elements[5] / d, h = a.elements[9] / e, k = a.elements[10] / e;
        this.y = Math.asin(a.elements[8] / e);
        e = Math.cos(this.y);
        if (Math.abs(e) > 1.0E-5) {
            this.x = Math.atan2(-h / e, k / e);
...
THREE.Frustum.prototype.setFromMatrix = function(a) {
    ...
    b = d[1];
    var e = d[2], f = d[3], g = d[4], h = d[5], k = d[6], j = d[7], l = d[8], o = d[9], m = d[10], p = d[11], q = d[12], n = d[13], r = d[14], d = d[15];
    c[0].set(f - a, j - g, p - l, d - q);
    c[1].set(f + a, j + g, p + l, d + q);
    c[2].set(f + b, j + h, p + o, d + n);
    c[3].set(f - b, j - h, p - o, d - n);
    c[4].set(f - e, j - k, p - m, d - r);
    c[5].set(f + e, j + k, p + m, d + r);
    for (a = 0; a < 6; a++) {
        b = c[a];
...
THREE.Ray.prototype = {constructor: THREE.Ray, setPrecision: function(a) {
        this.precision = a;
        return this
        ...
        return function(d, e, f) {
            ...
            a.sub(f, d);
            g = a.dot(e);
            d = b.add(d, c.copy(e).multiplyScalar(g));
            return f.distanceTo(d)
        }
    }(), pointInFace3: function() {
        var a =
                new THREE.Vector3, b = new THREE.Vector3, c = new THREE.Vector3;
        ...
        var b = [];
        a instanceof THREE.Particle ? this.intersectParticle(a, b) : a instanceof THREE.ParticleSystem ? this.intersectParticleSystem(a, b) : a instanceof THREE.Mesh && this.intersectMesh(a, b);
        return b
        ...
        for (var c = a.geometry.vertices, d, e, f = 0; f < c.length; f++) {
            d = c[f];
            e = this.distanceFromIntersection(this.origin, this.direction, a.matrixWorld.multiplyVector3(d.clone()));
            if (!(e > this.threshold)) {
                d = {distance: e, point: d.clone(), face: null, object: a, vertex: f};
                b.push(d)
            }
        }
    }, intersectMesh: function() {
        var a = new THREE.Vector3, b = new THREE.Vector3, c = new THREE.Vector3, d = new THREE.Vector3, e = new THREE.Vector3, f = new THREE.Vector3, g = new THREE.Vector3, h = new THREE.Vector3, k = new THREE.Vector3;
        return function(j, l) {
            var o, m = this.distanceFromIntersection(this.origin, this.direction, j.matrixWorld.getPosition()), p = THREE.Frustum.__v1.set(j.matrixWorld.getColumnX().length(), j.matrixWorld.getColumnY().length(),
                    j.matrixWorld.getColumnZ().length());
            if (m > j.geometry.boundingSphere.radius * Math.max(p.x, Math.max(p.y, p.z)))
                return l;
            var q, n, r = j.geometry, u = r.vertices, t;
            j.matrixRotationWorld.extractRotation(j.matrixWorld);
            m = 0;
            for (p = r.faces.length; m < p; m++) {
                o = r.faces[m];
                e.copy(this.origin);
                f.copy(this.direction);
                t = j.matrixWorld;
                g = t.multiplyVector3(g.copy(o.centroid)).subSelf(e);
                h = j.matrixRotationWorld.multiplyVector3(h.copy(o.normal));
                q = f.dot(h);
                if (!(Math.abs(q) < this.precision)) {
                    n = h.dot(g) / q;
                    if (!(n < 0) && (j.doubleSided ||
                            (j.flipSided ? q > 0 : q < 0))) {
                        k.add(e, f.multiplyScalar(n));
                        if (o instanceof THREE.Face3) {
                            a = t.multiplyVector3(a.copy(u[o.a]));
                            b = t.multiplyVector3(b.copy(u[o.b]));
                            c = t.multiplyVector3(c.copy(u[o.c]));
                            if (this.pointInFace3(k, a, b, c)) {
                                o = {distance: e.distanceTo(k), point: k.clone(), face: o, object: j};
                                l.push(o)
                            }
                            ...
                            b = t.multiplyVector3(b.copy(u[o.b]));
                            c = t.multiplyVector3(c.copy(u[o.c]));
                            d = t.multiplyVector3(d.copy(u[o.d]));
                            if (this.pointInFace3(k, a, b, d) ||
                                    this.pointInFace3(k, b, c, d)) {
                                o = {distance: e.distanceTo(k), point: k.clone(), face: o, object: j};
                                l.push(o)
                            }
                        }
...
THREE.Rectangle = function() {
    ...
    this.add3Points = function(f, g, l, o, m, p) {
        if (h) {
            h = false;
            b = f < l ? f < m ? f : m : l < m ? l : m;
            c = g < o ? g < p ? g : p : o < p ? o : p;
            d = f > l ? f > m ? f : m : l > m ? l : m;
            e = g > o ? g > p ? g : p : o > p ? o : p
        } else {
            b = f < l ? f < m ? f < b ? f : b : m < b ? m : b : l < m ? l < b ? l : b : m < b ? m : b;
            c = g < o ? g < p ? g < c ? g : c : p < c ? p : c : o < p ? o < c ? o : c : p < c ? p : c;
            d = f > l ? f > m ? f > d ? f : d : m > d ? m : d : l > m ? l > d ? l : d : m > d ? m : d;
            e = g > o ? g > p ? g > e ? g : e : p > e ? p : e : o > p ? o > e ? o : e : p > e ? p : e
        }
        a()
    };
...
THREE.Matrix3.prototype = {constructor: THREE.Matrix3, getInverse: function(a) {
        var b = a.elements, a = b[10] * b[5] - b[6] * b[9], c = -b[10] * b[1] + b[2] * b[9], d = b[6] * b[1] - b[2] * b[5], e = -b[10] * b[4] + b[6] * b[8], f = b[10] * b[0] - b[2] * b[8], g = -b[6] * b[0] + b[2] * b[4], h = b[9] * b[4] - b[5] * b[8], k = -b[9] * b[0] + b[1] * b[8], j = b[5] * b[0] - b[1] * b[4], b = b[0] * a + b[1] * e + b[2] * h;
...
THREE.Matrix4 = function(a, b, c, d, e, f, g, h, k, j, l, o, m, p, q, n) {
    this.elements = new Float32Array(16);
    this.set(a !== void 0 ? a : 1, b || 0, c || 0, d || 0, e || 0, f !== void 0 ? f : 1, g || 0, h || 0, k || 0, j || 0, l !== void 0 ? l : 1, o || 0, m || 0, p || 0, q || 0, n !== void 0 ? n : 1)
};
THREE.Matrix4.prototype = {constructor: THREE.Matrix4, set: function(a, b, c, d, e, f, g, h, k, j, l, o, m, p, q, n) {
        var r = this.elements;
        r[0] = a;
        r[4] = b;
        r[8] = c;
        ...
        var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], h = c[8], k = c[12], j = c[1], l = c[5], o = c[9], m = c[13], p = c[2], q = c[6], n = c[10], r = c[14], u = c[3], t = c[7], y = c[11], c = c[15], s = d[0], x = d[4],
                G = d[8], C = d[12], z = d[1], v = d[5], A = d[9], J = d[13], L = d[2], R = d[6], P = d[10], E = d[14], M = d[3], F = d[7], i = d[11], d = d[15];
        e[0] = f * s + g * z + h * L + k * M;
        e[4] = f * x + g * v + h * R + k * F;
        e[8] = f * G + g * A + h * P + k * i;
        e[12] = f * C + g * J + h * E + k * d;
        e[1] = j * s + l * z + o * L + m * M;
        e[5] = j * x + l * v + o * R + m * F;
        e[9] = j * G + l * A + o * P + m * i;
        e[13] = j * C + l * J + o * E + m * d;
        e[2] = p * s + q * z + n * L + r * M;
        e[6] = p * x + q * v + n * R + r * F;
        e[10] = p * G + q * A + n * P + r * i;
        e[14] = p * C + q * J + n * E + r * d;
        e[3] = u * s + t * z + y * L + c * M;
        e[7] = u * x + t * v + y * R + c * F;
        e[11] = u * G + t * A + y * P + c * i;
        e[15] = u * C + t * J + y * E + c * d;
        return this
    }, multiplySelf: function(a) {
        ...
        var a = this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], g = a[5], h = a[9], k = a[13], j = a[2], l = a[6], o = a[10], m = a[14], p = a[3], q = a[7],
                n = a[11], a = a[15];
        return e * h * l * p - d * k * l * p - e * g * o * p + c * k * o * p + d * g * m * p - c * h * m * p - e * h * j * q + d * k * j * q + e * f * o * q - b * k * o * q - d * f * m * q + b * h * m * q + e * g * j * n - c * k * j * n - e * f * l * n + b * k * l * n + c * f * m * n - b * g * m * n - d * g * j * a + c * h * j * a + d * f * l * a - b * h * l * a - c * f * o * a + b * g * o * a
    }, transpose: function() {
        ...
        var b = this.elements, c = a.elements, d = c[0], e = c[4], f = c[8], g = c[12], h = c[1], k = c[5], j = c[9], l = c[13], o = c[2], m = c[6], p = c[10], q =
                c[14], n = c[3], r = c[7], u = c[11], c = c[15];
        b[0] = j * q * r - l * p * r + l * m * u - k * q * u - j * m * c + k * p * c;
        b[4] = g * p * r - f * q * r - g * m * u + e * q * u + f * m * c - e * p * c;
        b[8] = f * l * r - g * j * r + g * k * u - e * l * u - f * k * c + e * j * c;
        b[12] = g * j * m - f * l * m - g * k * p + e * l * p + f * k * q - e * j * q;
        b[1] = l * p * n - j * q * n - l * o * u + h * q * u + j * o * c - h * p * c;
        b[5] = f * q * n - g * p * n + g * o * u - d * q * u - f * o * c + d * p * c;
        b[9] = g * j * n - f * l * n - g * h * u + d * l * u + f * h * c - d * j * c;
        b[13] = f * l * o - g * j * o + g * h * p - d * l * p - f * h * q + d * j * q;
        b[2] = k * q * n - l * m * n + l * o * r - h * q * r - k * o * c + h * m * c;
        b[6] = g * m * n - e * q * n - g * o * r + d * q * r + e * o * c - d * m * c;
        b[10] = e * l * n - g * k * n + g * h * r - d * l * r - e * h * c + d * k * c;
        b[14] = g * k * o -
                e * l * o - g * h * m + d * l * m + e * h * q - d * k * q;
        b[3] = j * m * n - k * p * n - j * o * r + h * p * r + k * o * u - h * m * u;
        b[7] = e * p * n - f * m * n + f * o * r - d * p * r - e * o * u + d * m * u;
        b[11] = f * k * n - e * j * n - f * h * r + d * j * r + e * h * u - d * k * u;
        b[15] = e * j * o - f * k * o + f * h * m - d * j * m - e * h * p + d * k * p;
        this.multiplyScalar(1 / a.determinant());
        return this
    }, setRotationFromEuler: function(a, b) {
        var c = this.elements, d = a.x, e = a.y, f = a.z, g = Math.cos(d), d = Math.sin(d), h = Math.cos(e), e = Math.sin(e), k = Math.cos(f), f = Math.sin(f);
        switch (b) {
            case "YXZ":
                var j = h * k, l = h * f, o = e * k, m = e * f;
                c[0] = j + m * d;
                c[4] = o * d - l;
                c[8] = g * e;
                c[1] = g * f;
        ...
        var b = this.elements, c = a.x, d = a.y, e = a.z, f = a.w, g = c + c, h = d + d, k = e + e, a = c * g, j = c * h, c = c * k, l = d * h, d = d * k, e = e * k, g = f * g, h = f * h, f = f * k;
        b[0] = 1 - (l + e);
        b[4] = j - f;
        b[8] = c + h;
        b[1] = j + f;
        ...
        var b = this.elements, c = b[4], d = b[5], e = b[6], f = b[7], g = b[8], h = b[9], k = b[10], j = b[11], l = Math.cos(a), a = Math.sin(a);
        b[4] = l * c + a * g;
        b[5] = l * d + a * h;
        b[6] = l * e + a * k;
        b[7] = l * f + a * j;
        ...
        var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], g = b[8], h = b[9], k = b[10], j = b[11], l = Math.cos(a), a = Math.sin(a);
        b[0] = l * c - a * g;
        b[1] = l * d - a * h;
        b[2] = l * e - a * k;
        b[3] = l * f - a * j;
        ...
        var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], g = b[4], h = b[5], k = b[6], j = b[7], l = Math.cos(a), a = Math.sin(a);
        b[0] = l * c + a * g;
        b[1] = l * d + a * h;
        b[2] = l * e + a * k;
        b[3] = l * f + a * j;
        ...
        var d = a.x,
                e = a.y, f = a.z, g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, h = e * e, k = f * f, j = Math.cos(b), l = Math.sin(b), o = 1 - j, m = d * e * o, p = d * f * o, o = e * f * o, d = d * l, q = e * l, l = f * l, f = g + (1 - g) * j, g = m + l, e = p - q, m = m - l, h = h + (1 - h) * j, l = o + d, p = p + q, o = o - d, k = k + (1 - k) * j, j = c[0], d = c[1], q = c[2], n = c[3], r = c[4], u = c[5], t = c[6], y = c[7], s = c[8], x = c[9], G = c[10], C = c[11];
        c[0] = f * j + g * r + e * s;
        c[1] = f * d + g * u + e * x;
        c[2] = f * q + g * t + e * G;
        c[3] = f * n + g * y + e * C;
    ...
    makeRotationX: function(a) {
        ...
        var c = Math.cos(b), d = Math.sin(b), e = 1 - c, f = a.x, g = a.y, h = a.z, k = e * f, j = e * g;
        this.set(k * f + c, k * g - d * h, k * h + d * g, 0, k * g + d * h, j * g + c, j * h - d * f, 0, k * h -
                d * g, j * h + d * f, e * h * h + c, 0, 0, 0, 0, 1);
        return this
        ...
        return this.makeFrustum(e * b, a * b, e, a, c, d)
            ...
            b, c, d, e, f) {
        var g = this.elements, h = b - a, k = c - d, j = f - e;
        g[0] = 2 / h;
        g[4] = 0;
        g[8] = 0;
        g[12] = -((b + a) / h);
...
THREE.Projector = function() {
    ...
    function b() {
        var a = j[k] = j[k] || new THREE.RenderableVertex;
        k++;
        return a
    }
    function c(a, b) {
    ...
    var e, f, g = [], h, k, j = [], l, o, m = [], p, q = [], n, r, u = [], t, y, s = [], x = {objects: [], sprites: [], lights: [], elements: []}, G = new THREE.Vector3, C = new THREE.Vector4, z = new THREE.Matrix4, v = new THREE.Matrix4, A = new THREE.Frustum, J = new THREE.Vector4, L = new THREE.Vector4;
        ...
        var g = function(b) {
            if (b.visible !== false) {
                if ((b instanceof THREE.Mesh || b instanceof THREE.Line) && (b.frustumCulled === false || A.contains(b))) {
                    G.copy(b.matrixWorld.getPosition());
                    z.multiplyVector3(G);
                    e = a();
                    e.object = b;
                    e.z = G.z;
                    ...
                    b instanceof THREE.Light && x.lights.push(b);
    ...
    this.projectScene = function(a, e, f) {
        var g = e.near, F = e.far, i = false, G, U, D, Y, I, ea, fa, ia, O, Q, Z, $, ha, Ma, Ka;
        y = r = p = o = 0;
        x.elements.length = 0;
        if (e.parent ===
                void 0) {
        ...
        A.setFromMatrix(z);
        x = this.projectGraph(a, false);
        a = 0;
        for (G = x.objects.length; a < G; a++) {
            O = x.objects[a].object;
            Q = O.matrixWorld;
            k = 0;
            if (O instanceof THREE.Mesh) {
                ...
                for (U = ha.length; Y < U; Y++) {
                    ...
                    if (D instanceof THREE.Face3) {
                        ...
                        ea = j[D.b];
                        fa = j[D.c];
                        if (I.visible && ea.visible && fa.visible) {
                            i = (fa.positionScreen.x - I.positionScreen.x) *
                                    (ea.positionScreen.y - I.positionScreen.y) - (fa.positionScreen.y - I.positionScreen.y) * (ea.positionScreen.x - I.positionScreen.x) < 0;
                            if (O.doubleSided || i != O.flipSided) {
                                ia = m[o] = m[o] || new THREE.RenderableFace3;
                                o++;
                                l = ia;
                                l.v1.copy(I);
                                l.v2.copy(ea);
                        ...
                        fa = j[D.c];
                        ia = j[D.d];
                        if (I.visible && ea.visible && fa.visible && ia.visible) {
                            i = (ia.positionScreen.x - I.positionScreen.x) * (ea.positionScreen.y - I.positionScreen.y) - (ia.positionScreen.y -
                                    I.positionScreen.y) * (ea.positionScreen.x - I.positionScreen.x) < 0 || (ea.positionScreen.x - fa.positionScreen.x) * (ia.positionScreen.y - fa.positionScreen.y) - (ea.positionScreen.y - fa.positionScreen.y) * (ia.positionScreen.x - fa.positionScreen.x) < 0;
                            if (O.doubleSided || i != O.flipSided) {
                                Ka = q[p] = q[p] || new THREE.RenderableFace4;
                                p++;
                                l = Ka;
                                l.v1.copy(I);
                                l.v2.copy(ea);
                    ...
                    l.normalWorld.copy(D.normal);
                    !i && (O.flipSided || O.doubleSided) && l.normalWorld.negate();
                    Z.multiplyVector3(l.normalWorld);
                    l.centroidWorld.copy(D.centroid);
                    Q.multiplyVector3(l.centroidWorld);
                    l.centroidScreen.copy(l.centroidWorld);
                    z.multiplyVector3(l.centroidScreen);
                    fa = D.vertexNormals;
                    I = 0;
                    for (ea = fa.length; I < ea; I++) {
                        ia = l.vertexNormalsWorld[I];
                        ia.copy(fa[I]);
                        !i && (O.flipSided || O.doubleSided) && ia.negate();
                        Z.multiplyVector3(ia)
                    }
                    I = 0;
                    for (ea = Ma.length; I < ea; I++)
                        if (Ka = Ma[I][Y]) {
                            fa = 0;
                    ...
                    l.faceMaterial = D.materialIndex !== null ? $[D.materialIndex] : null;
                ...
                I = b();
                I.positionScreen.copy(Y[0]);
                v.multiplyVector4(I.positionScreen);
                Q = O.type === THREE.LinePieces ? 2 : 1;
                U = 1;
                for (D = Y.length; U < D; U++) {
                    I = b();
                    I.positionScreen.copy(Y[U]);
                    v.multiplyVector4(I.positionScreen);
                    if (!((U + 1) % Q > 0)) {
                        ea = j[k - 2];
                        J.copy(I.positionScreen);
                        L.copy(ea.positionScreen);
                        if (d(J, L)) {
                            ...
                            n.v2.positionScreen.copy(L);
                            n.z = Math.max(J.z, L.z);
        ...
        a = 0;
        for (G = x.sprites.length; a < G; a++) {
            O = x.sprites[a].object;
            Q = O.matrixWorld;
            if (O instanceof THREE.Particle) {
                C.set(Q.elements[12], Q.elements[13], Q.elements[14], 1);
                z.multiplyVector4(C);
                C.z = C.z / C.w;
                if (C.z > 0 && C.z < 1) {
                    ...
                    t.scale.x = O.scale.x * Math.abs(t.x - (C.x + e.projectionMatrix.elements[0]) / (C.w + e.projectionMatrix.elements[12]));
                    t.scale.y = O.scale.y * Math.abs(t.y - (C.y + e.projectionMatrix.elements[5]) / (C.w + e.projectionMatrix.elements[13]));
...
THREE.Quaternion.prototype = {constructor: THREE.Quaternion, set: function(a, b, c, d) {
        ...
        b || (b = a);
        var c = a.x, d = a.y, e = a.z, f = this.x, g = this.y, h = this.z, k = this.w, j = k * c + g * e - h * d, l = k * d + h * c - f * e, o = k * e + f * d - g * c, c = -f * c - g * d - h * e;
        b.x = j * k + c * -f + l * -h - o * -g;
        b.y = l * k + c * -g + o * -f - j * -h;
        b.z = o * k + c * -h + j * -g - l * -f;
        return b
...
THREE.Geometry.prototype = {constructor: THREE.Geometry, applyMatrix: function(a) {
        ...
        for (b = this.morphTargets.length; a < b; a++) {
            if (!this.morphNormals[a]) {
                ...
                [];
                var g = this.morphNormals[a].faceNormals, h = this.morphNormals[a].vertexNormals, k, j;
                c = 0;
                for (d = this.faces.length; c < d; c++) {
                    e = this.faces[c];
                    k = new THREE.Vector3;
                    j = e instanceof THREE.Face3 ? {a: new THREE.Vector3, b: new THREE.Vector3, c: new THREE.Vector3} : {a: new THREE.Vector3, b: new THREE.Vector3, c: new THREE.Vector3, d: new THREE.Vector3};
                    g.push(k);
                    h.push(j)
                }
            }
        ...
        function a(a, b, c, d, e, f, I) {
            ...
            G = m.v - l.v;
            C = 1 / (y * G - s * x);
            J.set((G * p - x * q) * C, (G * n - x * r) * C, (G * u - x * t) * C);
            L.set((y * q - s * p) * C, (y * r - s * n) * C, (y * t - s * u) * C);
            v[b].addSelf(J);
            v[c].addSelf(J);
            v[d].addSelf(J);
            A[b].addSelf(L);
        ...
        var b, c, d, e, f, g, h, k, j, l, o, m, p, q, n, r, u, t, y, s, x, G, C, z, v = [], A = [], J = new THREE.Vector3, L = new THREE.Vector3, R = new THREE.Vector3, P = new THREE.Vector3, E = new THREE.Vector3;
        b = 0;
        for (c =
        ...
        for (c = this.faces.length; b < c; b++) {
            ...
            for (d = 0; d < f.vertexNormals.length; d++) {
                E.copy(f.vertexNormals[d]);
                e = f[M[d]];
                z = v[e];
                R.copy(z);
                R.subSelf(E.multiplyScalar(E.dot(z))).normalize();
...
THREE.Spline = function(a) {
    ...
    this.points = a;
    var c = [], d = {x: 0, y: 0, z: 0}, e, f, g, h, k, j, l, o, m;
    ...
    this.getPoint = function(a) {
        ...
        h = g * g;
        k = g * h;
        d.x = b(j.x, l.x, o.x, m.x, g, h, k);
        d.y = b(j.y, l.y, o.y, m.y, g, h, k);
        d.z = b(j.z, l.z, o.z, m.z, g, h, k);
        return d
    };
    ...
    this.reparametrizeByArcLength = function(a) {
        var b, c, d, e, f, g, h = [], k = new THREE.Vector3, j = this.getLength();
...
THREE.Loader.prototype = {constructor: THREE.Loader, crossOrigin: "anonymous", addStatusElement: function() {
        ...
        var h = this, k = "MeshLambertMaterial", j = {color: 15658734, opacity: 1, map: null, lightMap: null, normalMap: null, wireframe: a.wireframe};
        if (a.shading) {
            var l = a.shading.toLowerCase();
            l === "phong" ? k = "MeshPhongMaterial" : l === "basic" && (k = "MeshBasicMaterial")
        }
        ...
        if (a.mapNormal) {
            ...
            l = THREE.UniformsUtils.clone(k.uniforms);
            l.tNormal.texture = j.normalMap;
            if (a.mapNormalFactor)
                l.uNormalScale.value = a.mapNormalFactor;
            if (j.map) {
            ...
            if (j.opacity !== void 0)
                l.uOpacity.value = j.opacity;
            j = new THREE.ShaderMaterial({fragmentShader: k.fragmentShader, vertexShader: k.vertexShader, uniforms: l, lights: true, fog: true})
        } else
            j = new THREE[k](j);
        if (a.DbgName !== void 0)
            j.name = a.DbgName;
...
THREE.BinaryLoader.prototype.createBinModel = function(a, b, c, d) {
    var e = function(b) {
        var c, e, k, j, l, o, m, p, q, n, r, u, t, y, s;
        function x(a) {
            return a % 4 ? 4 - a % 4 : 0
        }
        function G(a, b) {
        ...
        function z(b, c) {
            var d, e, f, g, h, i, k, j, l = new Uint32Array(a, c, 3 * b);
            for (d = 0; d < b; d++) {
                e = l[d * 3];
                f = l[d * 3 + 1];
                g = l[d * 3 + 2];
        ...
        function v(b, c) {
            var d, e, f, g, h, i, k, j, l, m, n = new Uint32Array(a, c, 4 * b);
            for (d = 0; d < b; d++) {
                e = n[d * 4];
                f = n[d * 4 + 1];
                g = n[d * 4 + 2];
                ...
                o.push(new THREE.UV(k, l));
                o.push(new THREE.UV(j, m));
        ...
        function J(b, c, d) {
            for (var e, f, g, h, i, c = new Uint32Array(a, c, 4 * b), k = new Uint16Array(a, d, b), d = 0; d < b; d++) {
                e = c[d * 4];
                f = c[d * 4 + 1];
                g = c[d * 4 + 2];
                h = c[d * 4 + 3];
        ...
        function L(b, c, d, e) {
            for (var f, g, h, i, k, j, l, c = new Uint32Array(a, c, 3 * b), d = new Uint32Array(a, d, 3 * b), m = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                f = c[e * 3];
                g = c[e * 3 + 1];
                h = c[e * 3 + 2];
                k = d[e * 3];
                ...
                l = d[e * 3 + 2];
                i = m[e];
                var n = M[j * 3], o = M[j * 3 + 1];
                j = M[j * 3 + 2];
                var p = M[l * 3],
                        q = M[l * 3 + 1];
                l = M[l * 3 + 2];
                P.faces.push(new THREE.Face3(f, g, h, [new THREE.Vector3(M[k * 3], M[k * 3 + 1], M[k * 3 + 2]), new THREE.Vector3(n, o, j), new THREE.Vector3(p, q, l)], null, i))
            }
        }
        function R(b, c, d, e) {
            for (var f, g, h, i, k, j, l, m, n, c = new Uint32Array(a, c, 4 * b), d = new Uint32Array(a, d, 4 * b), o = new Uint16Array(a, e, b), e = 0; e < b; e++) {
                f = c[e * 4];
                g = c[e * 4 + 1];
                h = c[e * 4 + 2];
                i = c[e * 4 + 3];
                ...
                P.faces.push(new THREE.Face4(f,
                        g, h, i, [new THREE.Vector3(M[j * 3], M[j * 3 + 1], M[j * 3 + 2]), new THREE.Vector3(p, q, l), new THREE.Vector3(r, s, m), new THREE.Vector3(t, u, n)], null, k))
            }
        }
        var P = this, E = 0, M = [], F = [], i, T, U;
        ...
        j = y * (U + j * 4);
        E = E + function(b) {
            var b = new Float32Array(a, b, o * 3), c, d, e, f;
            for (c = 0; c < o; c++) {
                d = b[c * 3];
                e = b[c * 3 + 1];
                f = b[c * 3 + 2];
            ...
            return o * 3 * Float32Array.BYTES_PER_ELEMENT
        }(E);
        E = E + function(b) {
            if (m) {
        ...
        E = E + function(b) {
            if (p) {
                var b = new Float32Array(a, b, p * 2), c, d, e;
                for (c = 0; c < p; c++) {
                    d = b[c * 2];
                    e = b[c * 2 + 1];
                    F.push(d, e)
        ...
        (function(a) {
            if (r) {
                ...
                L(r, a, b, c + r * Uint32Array.BYTES_PER_ELEMENT * 3);
                z(r, c)
            }
        })(e);
        (function(a) {
        ...
        b && A(b, E, E + b * Uint32Array.BYTES_PER_ELEMENT * 3);
        (function(a) {
            if (q) {
                var b = a + q * Uint32Array.BYTES_PER_ELEMENT * 3;
                L(q, a, b, b + q * Uint32Array.BYTES_PER_ELEMENT *
                        3)
            }
        })(i);
        u && J(u, l, l + u * Uint32Array.BYTES_PER_ELEMENT * 4);
        (function(a) {
            if (t) {
...
THREE.JSONLoader.prototype.createModel = function(a, b, c) {
    ...
    (function(b) {
        var c, e, k, j, l, o, m, p, q, n, r, u, t, y, s = a.faces;
        o = a.vertices;
        var x = a.normals, G = a.colors, C = 0;
        ...
        for (l = s.length; j < l; ) {
            ...
            if (c)
                for (c = 0; c < C; c++) {
                    ...
                    y = u[q * 2];
                    q = u[q * 2 + 1];
                    d.faceUvs[c][k] = new THREE.UV(y, q)
                }
            if (e)
                for (c = 0; c < C; c++) {
                    u = a.uvs[c];
    ...
    (function() {
        ...
        if (a.skinWeights) {
            ...
            for (c = a.skinWeights.length; b < c; b = b + 2) {
                e = a.skinWeights[b];
                k = a.skinWeights[b + 1];
                d.skinWeights.push(new THREE.Vector4(e, k, 0, 0))
            }
        }
        if (a.skinIndices) {
            b = 0;
            for (c = a.skinIndices.length; b < c; b =
                ...
                e = a.skinIndices[b];
                k = a.skinIndices[b + 1];
                d.skinIndices.push(new THREE.Vector4(e, k, 0, 0))
            }
        }
        d.bones = a.bones;
    ...
    (function(b) {
        ...
        if (a.morphColors !==
            ...
            for (e = a.morphColors.length; c < e; c++) {
                ...
                b = 0;
                for (k = l.length; b < k; b = b + 3) {
                    o = new THREE.Color(16755200);
                    o.setRGB(l[b], l[b + 1], l[b + 2]);
                    j.push(o)
                }
            }
        }
...
THREE.SceneLoader.prototype.createScene = function(a, b, c) {
        ...
        for (m in E.objects)
            if (!D.objects[m]) {
                ...
                if (u.geometry !== void 0) {
                    if (J = D.geometries[u.geometry]) {
                        a = false;
                        L = D.materials[u.materials[0]];
                        (a = L instanceof THREE.ShaderMaterial) && J.computeTangents();
                        x = u.position;
                        G = u.rotation;
                        C = u.quaternion;
                        z = u.scale;
                        t = u.matrix;
                        C = 0;
                        u.materials.length == 0 && (L = new THREE.MeshFaceMaterial);
                        u.materials.length > 1 && (L = new THREE.MeshFaceMaterial);
                        a = new THREE.Mesh(J, L);
                        a.name = m;
                        if (t) {
                            ...
                            if (C) {
                                a.quaternion.set(C[0], C[1], C[2], C[3]);
                                a.useQuaternion = true
                            } else
                                a.rotation.set(G[0], G[1], G[2]);
    ...
    function h() {
        k.callbackProgress({totalModels: T, totalTextures: U, loadedModels: T -
            F, loadedTextures: U - i}, D);
        k.onLoadProgress();
        F == 0 && i == 0 && b(D)
    }
    var k = this, j = THREE.Loader.prototype.extractUrlBase(c), l, o, m, p, q, n, r, u, t, y, s, x, G, C, z, v, A, J, L, R, P, E, M, F, i, T, U, D;
    E = a;
    c = new THREE.BinaryLoader;
    M = new THREE.JSONLoader;
    i = F = 0;
    D = {scene: new THREE.Scene, geometries: {}, materials: {}, textures: {}, objects: {}, cameras: {}, lights: {}, fogs: {}, empties: {}};
    if (E.transform) {
        a = E.transform.position;
        y = E.transform.rotation;
        v = E.transform.scale;
        a && D.scene.position.set(a[0], a[1], a[2]);
        y && D.scene.rotation.set(y[0], y[1],
                y[2]);
        v && D.scene.scale.set(v[0], v[1], v[2]);
        if (a || y || v) {
            D.scene.updateMatrix();
    ...
    for (n in E.fogs) {
        p = E.fogs[n];
        p.type == "linear" ? P = new THREE.Fog(0, p.near,
                p.far) : p.type == "exp2" && (P = new THREE.FogExp2(0, p.density));
        v = p.color;
        P.color.setRGB(v[0], v[1], v[2]);
        D.fogs[n] = P
    }
    if (D.cameras && E.defaults.camera)
        D.currentCamera = D.cameras[E.defaults.camera];
    if (D.fogs && E.defaults.fog)
        D.scene.fog = D.fogs[E.defaults.fog];
    v = E.defaults.bgcolor;
    D.bgColor = new THREE.Color;
    D.bgColor.setRGB(v[0], v[1], v[2]);
    D.bgColorAlpha = E.defaults.bgalpha;
    for (l in E.geometries) {
        n = E.geometries[l];
    ...
    for (l in E.geometries) {
        ...
        if (n.type == "cube") {
            ...
            c.load(d(n.url, E.urlBaseType), f(l));
        else if (n.type == "ascii_mesh")
            M.load(d(n.url, E.urlBaseType), f(l));
        else if (n.type == "embedded_mesh") {
            n = E.embeds[n.id];
            n.metadata = E.metadata;
            n && M.createModel(n, g(l), "")
        }
    }
    for (r in E.textures) {
        l = E.textures[r];
    ...
    for (r in E.textures) {
        ...
        if (l.url instanceof Array) {
            n = [];
            for (P = 0; P < l.url.length; P++)
                n[P] = d(l.url[P], E.urlBaseType);
            n = THREE.ImageUtils.loadTextureCube(n, l.mapping, a)
        } else {
            n = THREE.ImageUtils.loadTexture(d(l.url, E.urlBaseType), l.mapping, a);
            if (THREE[l.minFilter] != void 0)
                n.minFilter = THREE[l.minFilter];
            if (THREE[l.magFilter] != void 0)
                n.magFilter = THREE[l.magFilter];
            if (l.repeat) {
                n.repeat.set(l.repeat[0], l.repeat[1]);
                if (l.repeat[0] != 1)
                    n.wrapS = THREE.RepeatWrapping;
                if (l.repeat[1] != 1)
                    n.wrapT = THREE.RepeatWrapping
            }
            l.offset && n.offset.set(l.offset[0], l.offset[1]);
            if (l.wrap) {
                P = {repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping};
                if (P[l.wrap[0]] !== void 0)
                    n.wrapS = P[l.wrap[0]];
                if (P[l.wrap[1]] !== void 0)
                    n.wrapT = P[l.wrap[1]]
            }
        }
        D.textures[r] = n
    }
    for (o in E.materials) {
        t = E.materials[o];
        for (A in t.parameters)
            if (A ==
                    "envMap" || A == "map" || A == "lightMap")
                t.parameters[A] = D.textures[t.parameters[A]];
            else if (A == "shading")
        ...
        if (t.parameters.normalMap) {
            ...
            l = t.parameters.color;
            n = t.parameters.specular;
            P = t.parameters.ambient;
            c = t.parameters.shininess;
            a.tNormal.texture = D.textures[t.parameters.normalMap];
            ...
            if (t.parameters.specularMap) {
                a.tSpecular.texture = D.textures[t.parameters.specularMap];
            ...
            L = new THREE.ShaderMaterial({fragmentShader: r.fragmentShader, vertexShader: r.vertexShader, uniforms: a, lights: true, fog: true})
        } else
            L =
...
THREE.DataTexture = function(a, b, c, d, e, f, g, h, k, j) {
    THREE.Texture.call(this, null, f, g, h, k, j, d, e);
    ...
    this.render = function(c, d) {
        ...
        for (o =
            ...
            if (m instanceof THREE.RenderableParticle && m.material instanceof THREE.ParticleDOMMaterial) {
                p = m.material.domElement;
                q = m.x * e + e - (p.offsetWidth >> 1);
                n = m.y * f + f - (p.offsetHeight >> 1);
                p.style.left = q + "px";
                p.style.top = n + "px";
                p.style.zIndex = Math.abs(Math.floor((1 - m.z) * d.far / d.near));
                g && (p.style[g] = "scale(" + m.scale.x * e + "," + m.scale.y * f + ")")
            }
        }
    }
};
THREE.CanvasRenderer = function(a) {
    ...
    var a = a || {}, f = this, g, h, k, j = new THREE.Projector, l = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"), o, m, p, q, n = l.getContext("2d"),
            r = new THREE.Color(0), u = 0, t = 1, y = 0, s = null, x = null, G = null, C = null, z = null, v, A, J, L, R = new THREE.RenderableVertex, P = new THREE.RenderableVertex, E, M, F, i, T, U, D, Y, I, ea, fa, ia, O = new THREE.Color, Q = new THREE.Color, Z = new THREE.Color, $ = new THREE.Color, ha = new THREE.Color, Ma = [], Ka = [], Ra, La, Sa, Na, Lb, lb, gb, Mb, hb, Cb, Wa = new THREE.Rectangle, Ba = new THREE.Rectangle, xa = new THREE.Rectangle, $a = false, aa = new THREE.Color, Ta = new THREE.Color, Qa = new THREE.Color, oa = new THREE.Vector3, ib, Db, Sc, ab, Eb, Bc, a = 16;
    ...
    this.render = function(a, l) {
        ...
        function o(a, b, c, d) {
            ...
            for (f = a.length; e < f; e++) {
                ...
                if (g instanceof THREE.DirectionalLight) {
                    ...
                    h = g.matrixWorld.getPosition();
                    k = c.dot(oa.sub(h, b).normalize());
                    if (!(k <= 0)) {
                        k = k * (g.distance == 0 ? 1 : 1 - Math.min(b.distanceTo(h) / g.distance, 1));
                        if (k != 0) {
                            k = k * g.intensity;
                            d.r = d.r + i.r * k;
                            d.g = d.g + i.g * k;
            ...
            if (n instanceof THREE.MeshBasicMaterial)
                if (n.map) {
                    if (n.map.mapping instanceof THREE.UVMapping) {
                        Na = m.uvs[0];
                        ad(E, M, F, i, T, U, Na[g].u, Na[g].v, Na[h].u, Na[h].v, Na[j].u, Na[j].v, n.map)
                    }
                } else if (n.envMap) {
                    if (n.envMap.mapping instanceof THREE.SphericalReflectionMapping) {
                        ...
                        Lb = (oa.x * a.elements[0] + oa.y * a.elements[4] + oa.z * a.elements[8]) * 0.5 + 0.5;
                        ...
                        Mb = -(oa.x * a.elements[1] + oa.y * a.elements[5] + oa.z * a.elements[9]) * 0.5 + 0.5;
                        oa.copy(m.vertexNormalsWorld[j]);
                        ...
                        ad(E, M, F, i, T, U, Lb, lb, gb, Mb, hb, Cb, n.envMap)
                    }
                } else
                    n.wireframe ? Nb(n.color, n.wireframeLinewidth, n.wireframeLinecap, n.wireframeLinejoin) : Fb(n.color);
                ...
                if ($a)
                    if (!n.wireframe && n.shading == THREE.SmoothShading && m.vertexNormalsWorld.length == 3) {
                        ...
                        Q.g = Z.g = $.g = aa.g;
                        Q.b = Z.b = $.b = aa.b;
                        o(k, m.v1.positionWorld, m.vertexNormalsWorld[0], Q);
                        o(k, m.v2.positionWorld, m.vertexNormalsWorld[1], Z);
                        o(k, m.v3.positionWorld, m.vertexNormalsWorld[2],
                                $);
                        ...
                        ha.b = (Z.b + $.b) * 0.5;
                        Sa = Cc(Q, Z, $, ha);
                        hc(E, M, F, i, T, U, 0, 0, 1, 0, 0, 1, Sa)
                    } else {
                        O.r = aa.r;
                        O.g =
                                aa.g;
                        O.b = aa.b;
                        o(k, m.centroidWorld, m.normalWorld, O);
                        O.r = Math.max(0, Math.min(n.color.r * O.r, 1));
                        O.g = Math.max(0, Math.min(n.color.g * O.g, 1));
                        O.b = Math.max(0, Math.min(n.color.b * O.b, 1));
                        n.wireframe ? Nb(O, n.wireframeLinewidth, n.wireframeLinecap, n.wireframeLinejoin) : Fb(O)
                    }
                else
                    n.wireframe ? Nb(n.color, n.wireframeLinewidth, n.wireframeLinecap, n.wireframeLinejoin) : Fb(n.color);
                ...
                Ra = l.near;
                La = l.far;
                Q.r = Q.g = Q.b = 1 - bc(a.positionScreen.z, Ra, La);
                Z.r = Z.g = Z.b = 1 - bc(d.positionScreen.z,
                        Ra, La);
                $.r = $.g = $.b = 1 - bc(e.positionScreen.z, Ra, La);
                ha.r = (Z.r + $.r) * 0.5;
                ha.g = (Z.g + $.g) * 0.5;
                ha.b = (Z.b + $.b) * 0.5;
                Sa = Cc(Q, Z, $, ha);
                ...
                O.r = ic(m.normalWorld.x);
                O.g = ic(m.normalWorld.y);
                O.b = ic(m.normalWorld.z);
                n.wireframe ? Nb(O, n.wireframeLinewidth, n.wireframeLinecap, n.wireframeLinejoin) : Fb(O)
            }
        }
        function u(a, d, e, g, h, j, n, m, p) {
            ...
            if (m.map || m.envMap) {
                ...
                T = e.positionScreen.x;
                U = e.positionScreen.y;
                D = g.positionScreen.x;
                Y = g.positionScreen.y;
                I = h.positionScreen.x;
                ea = h.positionScreen.y;
                fa = j.positionScreen.x;
                ia = j.positionScreen.y;
                if (m instanceof THREE.MeshBasicMaterial) {
                    y(E, M, F, i, T, U, D, Y);
                    m.wireframe ? Nb(m.color, m.wireframeLinewidth, m.wireframeLinecap, m.wireframeLinejoin) : Fb(m.color)
                    ...
                    if ($a)
                        if (!m.wireframe &&
                            ...
                            Q.g = Z.g = $.g = ha.g = aa.g;
                            Q.b = Z.b = $.b = ha.b = aa.b;
                            o(k, n.v1.positionWorld, n.vertexNormalsWorld[0], Q);
                            o(k, n.v2.positionWorld, n.vertexNormalsWorld[1], Z);
                            o(k, n.v4.positionWorld, n.vertexNormalsWorld[3], $);
                            o(k, n.v3.positionWorld, n.vertexNormalsWorld[2], ha);
                            ...
                            Sa = Cc(Q, Z, $, ha);
                            x(E, M, F, i, D, Y);
                            hc(E, M, F, i, D, Y, 0, 0, 1, 0, 0, 1, Sa);
                            x(I, ea, T, U, fa, ia);
                            hc(I, ea, T, U, fa, ia, 1, 0, 1, 1, 0, 1, Sa)
                        } else {
                            O.r = aa.r;
                            O.g = aa.g;
                            O.b = aa.b;
                            ...
                            y(E, M, F, i, T, U, D, Y);
                            m.wireframe ? Nb(O, m.wireframeLinewidth, m.wireframeLinecap, m.wireframeLinejoin) : Fb(O)
                        }
                    else {
                        y(E, M, F, i, T, U, D, Y);
                        m.wireframe ? Nb(m.color, m.wireframeLinewidth, m.wireframeLinecap, m.wireframeLinejoin) : Fb(m.color)
                    ...
                    O.r = ic(n.normalWorld.x);
                    O.g = ic(n.normalWorld.y);
                    O.b = ic(n.normalWorld.z);
                    y(E, M, F, i, T, U, D,
                            Y);
                    m.wireframe ? Nb(O, m.wireframeLinewidth, m.wireframeLinecap, m.wireframeLinejoin) : Fb(O)
                    ...
                    La = l.far;
                    Q.r = Q.g = Q.b = 1 - bc(a.positionScreen.z, Ra, La);
                    Z.r = Z.g = Z.b = 1 - bc(d.positionScreen.z, Ra, La);
                    $.r = $.g = $.b = 1 - bc(g.positionScreen.z, Ra, La);
                    ha.r = ha.g = ha.b = 1 - bc(e.positionScreen.z, Ra, La);
                    Sa = Cc(Q, Z, $, ha);
                    x(E, M, F, i, D, Y);
                    hc(E, M, F, i, D, Y, 0, 0, 1, 0, 0, 1, Sa);
                    x(I, ea, T, U, fa, ia);
        ...
        function ad(a, b, c, d, f, g, i, h, k, j, l, m, o) {
            if (o.image.width != 0) {
                if (o.needsUpdate == true || Ma[o.id] == void 0) {
                    var p = o.wrapS == THREE.RepeatWrapping, q = o.wrapT ==
                            THREE.RepeatWrapping;
                    Ma[o.id] = n.createPattern(o.image, p && q ? "repeat" : p && !q ? "repeat-x" : !p && q ? "repeat-y" : "no-repeat");
                    o.needsUpdate = false
                }
                e(Ma[o.id]);
                var p = o.offset.x / o.repeat.x, q = o.offset.y / o.repeat.y, Db = o.image.width * o.repeat.x, Eb = o.image.height * o.repeat.y, i = (i + p) * Db, h = (h + q) * Eb, c = c - a, d = d - b, f = f - a, g = g - b, k = (k + p) * Db - i, j = (j + q) * Eb - h, l = (l + p) * Db - i, m = (m + q) * Eb - h, p = k * m - l * j;
                if (p == 0) {
                    if (Ka[o.id] === void 0) {
                        b = document.createElement("canvas");
                        b.width = o.image.width;
                        b.height = o.image.height;
                        b = b.getContext("2d");
                        b.drawImage(o.image,
                                0, 0);
                        Ka[o.id] = b.getImageData(0, 0, o.image.width, o.image.height).data
                    }
                    b = Ka[o.id];
                    i = (Math.floor(i) + Math.floor(h) * o.image.width) * 4;
                    ...
                    i = b - j * i - d * h;
                    n.save();
                    n.transform(o, j, c, d, a, i);
                    n.fill();
                    n.restore()
                }
            }
        }
        function hc(a, b, c, d, e, f, g, i, h, k, j, l, m) {
            var o, p;
            o = m.width - 1;
            p = m.height - 1;
            g = g * o;
            ...
            b = b - k * g - d * i;
            n.save();
            n.transform(o, k, c, d, a, b);
            n.clip();
            n.drawImage(m, 0, 0);
            n.restore()
        }
        function Cc(a, b, c, d) {
            var e = ~~(a.r * 255), f = ~~(a.g * 255), a = ~~(a.b * 255), g = ~~(b.r * 255), i = ~~(b.g * 255), b = ~~(b.b * 255), h = ~~(c.r * 255), k = ~~(c.g * 255), c = ~~(c.b * 255), j = ~~(d.r * 255), l = ~~(d.g * 255), d = ~~(d.b * 255);
        ...
        var Dc, bd, Ha, eb;
        this.autoClear ? this.clear() : n.setTransform(1, 0, 0, -1, p, q);
        ...
        for (bd = h.length; Dc < bd; Dc++) {
            ...
            if (!(eb === void 0 || eb.visible === false)) {
                ...
                if (Ha instanceof THREE.RenderableParticle) {
                    ...
                    v = Ha.v1;
                    A = Ha.v2;
                    v.positionScreen.x = v.positionScreen.x * p;
                    ...
                    v.positionScreen.x = v.positionScreen.x * p;
                    v.positionScreen.y = v.positionScreen.y * q;
                    A.positionScreen.x = A.positionScreen.x * p;
                    A.positionScreen.y = A.positionScreen.y * q;
                    ...
                    if (eb.overdraw) {
                        Ob(v.positionScreen,
                                A.positionScreen);
                        Ob(A.positionScreen, J.positionScreen);
                        Ob(J.positionScreen, v.positionScreen)
                    }
                    ...
                    J.positionScreen.x = J.positionScreen.x * p;
                    J.positionScreen.y = J.positionScreen.y * q;
                    L.positionScreen.x = L.positionScreen.x * p;
                    L.positionScreen.y = L.positionScreen.y * q;
                    R.positionScreen.copy(A.positionScreen);
                    P.positionScreen.copy(L.positionScreen);
                    if (eb.overdraw) {
                        Ob(v.positionScreen, A.positionScreen);
                        Ob(A.positionScreen, L.positionScreen);
                        Ob(L.positionScreen, v.positionScreen);
                        Ob(J.positionScreen, R.positionScreen);
                        Ob(J.positionScreen, P.positionScreen)
                    }
                    xa.addPoint(v.positionScreen.x, v.positionScreen.y);
                    xa.addPoint(A.positionScreen.x,
                            A.positionScreen.y);
                    xa.addPoint(J.positionScreen.x, J.positionScreen.y);
                    xa.addPoint(L.positionScreen.x, L.positionScreen.y);
                    Wa.intersects(xa) && u(v, A, J, L, R, P, Ha, eb, a)
                }
                Ba.addRectangle(xa)
            }
        }
...
THREE.SVGRenderer = function() {
    function a(a, b, c, d) {
        ...
        for (f = a.length; e < f; e++) {
            ...
            if (g instanceof THREE.DirectionalLight) {
                ...
                k = g.matrixWorld.getPosition();
                j = c.dot(v.sub(k, b).normalize());
                if (!(j <= 0)) {
                    j = j * (g.distance == 0 ? 1 : 1 - Math.min(b.distanceTo(k) / g.distance, 1));
                    if (j != 0) {
                        j = j * g.intensity;
                        d.r = d.r + h.r * j;
                        d.g = d.g + h.g * j;
    ...
    function b(a) {
        if (A[a] == null) {
            ...
            E == 0 && A[a].setAttribute("shape-rendering", "crispEdges")
        }
        return A[a]
    }
    function c(a) {
    ...
    var d = this, e, f, g, h = new THREE.Projector, k = document.createElementNS("http://www.w3.org/2000/svg", "svg"), j, l, o, m, p, q, n, r, u = new THREE.Rectangle, t = new THREE.Rectangle, y = false, s = new THREE.Color, x = new THREE.Color, G = new THREE.Color, C = new THREE.Color,
            z, v = new THREE.Vector3, A = [], J = [], L, R, P, E = 1;
    this.domElement = k;
    this.sortElements = this.sortObjects = this.autoClear = true;
    this.info = {render: {vertices: 0, faces: 0}};
    ...
    this.setSize = function(a, b) {
        ...
        o = j / 2;
        m = l / 2;
        k.setAttribute("viewBox", -o + " " + -m + " " + j + " " + l);
        k.setAttribute("width", j);
        k.setAttribute("height", l);
        u.set(-o, -m, o, m)
    };
    this.clear = function() {
    ...
    this.render = function(j,
        ...
        e = h.projectScene(j, l, this.sortElements);
        f = e.elements;
        g = e.lights;
        P = R = 0;
        if (y = g.length > 0) {
        ...
        for (v = f.length; i < v; i++) {
            A = f[i];
            D = A.material;
            D = D instanceof THREE.MeshFaceMaterial ? A.faceMaterial : D;
            if (!(D === void 0 || D.visible === false)) {
                t.empty();
                if (A instanceof THREE.RenderableParticle) {
                    ...
                    p = A.v1;
                    q = A.v2;
                    p.positionScreen.x = p.positionScreen.x * o;
                    p.positionScreen.y = p.positionScreen.y * -m;
                    q.positionScreen.x = q.positionScreen.x * o;
                    ...
                    if (u.intersects(t)) {
                        ...
                        var Y = q, I = P++;
                        if (J[I] == null) {
                            J[I] = document.createElementNS("http://www.w3.org/2000/svg", "line");
                            E == 0 && J[I].setAttribute("shape-rendering", "crispEdges")
                        }
                        L = J[I];
                        L.setAttribute("x1", A.positionScreen.x);
                        L.setAttribute("y1", A.positionScreen.y);
                        L.setAttribute("x2", Y.positionScreen.x);
                        L.setAttribute("y2", Y.positionScreen.y);
                        if (D instanceof THREE.LineBasicMaterial) {
                            L.setAttribute("style", "fill: none; stroke: " + D.color.getContextStyle() + "; stroke-width: " + D.linewidth +
                                    "; stroke-opacity: " + D.opacity + "; stroke-linecap: " + D.linecap + "; stroke-linejoin: " + D.linejoin);
                            k.appendChild(L)
                        }
                    }
                    ...
                    q.positionScreen.x = q.positionScreen.x * o;
                    q.positionScreen.y = q.positionScreen.y * -m;
                    n.positionScreen.x = n.positionScreen.x * o;
                    ...
                    if (u.intersects(t)) {
                        ...
                        d.info.render.faces++;
                        L = b(R++);
                        L.setAttribute("d", "M " + Y.positionScreen.x + " " + Y.positionScreen.y + " L " + I.positionScreen.x + " " + I.positionScreen.y + " L " + ea.positionScreen.x + "," + ea.positionScreen.y + "z");
                        if (D instanceof THREE.MeshBasicMaterial)
                            ...
                            if (y) {
                                ...
                                a(g, A.centroidWorld,
                                        A.normalWorld, s);
                                s.r = Math.max(0, Math.min(D.color.r * s.r, 1));
                                s.g = Math.max(0, Math.min(D.color.g * s.g, 1));
                                s.b = Math.max(0, Math.min(D.color.b * s.b, 1))
                            } else
                                s.copy(D.color);
                        else if (D instanceof THREE.MeshDepthMaterial) {
                            z = 1 - D.__2near / (D.__farPlusNear - A.z * D.__farMinusNear);
                            s.setRGB(z, z, z)
                        } else
                            D instanceof THREE.MeshNormalMaterial && s.setRGB(c(A.normalWorld.x), c(A.normalWorld.y), c(A.normalWorld.z));
                        D.wireframe ? L.setAttribute("style", "fill: none; stroke: " + s.getContextStyle() + "; stroke-width: " + D.wireframeLinewidth +
                                "; stroke-opacity: " + D.opacity + "; stroke-linecap: " + D.wireframeLinecap + "; stroke-linejoin: " + D.wireframeLinejoin) : L.setAttribute("style", "fill: " + s.getContextStyle() + "; fill-opacity: " + D.opacity);
                        k.appendChild(L)
                    }
                    ...
                    r.positionScreen.x = r.positionScreen.x * o;
                    ...
                    if (u.intersects(t)) {
                        var Y = p, I = q, ea = n, fa = r;
                        d.info.render.vertices = d.info.render.vertices + 4;
                        d.info.render.faces++;
                        L = b(R++);
                        L.setAttribute("d", "M " + Y.positionScreen.x + " " + Y.positionScreen.y + " L " + I.positionScreen.x +
                                " " + I.positionScreen.y + " L " + ea.positionScreen.x + "," + ea.positionScreen.y + " L " + fa.positionScreen.x + "," + fa.positionScreen.y + "z");
                        if (D instanceof THREE.MeshBasicMaterial)
                            s.copy(D.color);
                        else if (D instanceof THREE.MeshLambertMaterial)
                            if (y) {
                            ...
                            z = 1 - D.__2near /
                                    (D.__farPlusNear - A.z * D.__farMinusNear);
                            s.setRGB(z, z, z)
                        } else
                            D instanceof THREE.MeshNormalMaterial && s.setRGB(c(A.normalWorld.x), c(A.normalWorld.y), c(A.normalWorld.z));
                        D.wireframe ? L.setAttribute("style", "fill: none; stroke: " + s.getContextStyle() + "; stroke-width: " + D.wireframeLinewidth + "; stroke-opacity: " + D.opacity + "; stroke-linecap: " + D.wireframeLinecap + "; stroke-linejoin: " + D.wireframeLinejoin) : L.setAttribute("style", "fill: " + s.getContextStyle() + "; fill-opacity: " + D.opacity);
                        k.appendChild(L)
                    }
                }
            }
...
THREE.WebGLRenderer = function(a) {
    ...
    function f(a, b, c) {
        ...
        g = h.length;
        var k = a.colors, j = k.length, l = a.__vertexArray, m = a.__colorArray, n = a.__sortArray, o = a.verticesNeedUpdate, p = a.colorsNeedUpdate, q = a.__webglCustomAttributesList;
        if (c.sortParticles) {
            xa.copy(Ba);
    ...
    function k(a, b, c, d, e, f, g, h) {
        ...
        for (var m = k; m !== b; m = m + l) {
            ...
            if (i.render) {
                ...
                F.setObjectFaces(k);
                j instanceof THREE.BufferGeometry ? F.renderBufferDirect(d, e, f, i, j, k) : F.renderBuffer(d, e, f, i, j, k)
            }
        }
    }
    ...
    function n(a, b, c, d, e) {
        ...
        var h = false, f = d.program, g = f.uniforms, k = d.uniforms;
        if (f !== U) {
            i.useProgram(f);
            U = f;
            h = true
        ...
        if (h) {
            ...
            if (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d.lights) {
                if (Ta) {
                    for (var j, l = 0, m = 0, n = 0, o, p, q, r = Qa, s = r.directional.colors, t = r.directional.positions, u = r.point.colors, v = r.point.positions, x = r.point.distances,
                            z = r.spot.colors, A = r.spot.positions, E = r.spot.distances, D = r.spot.directions, I = r.spot.angles, L = r.spot.exponents, Q = 0, J = 0, M = 0, O = q = 0, c = O = 0, h = b.length; c < h; c++) {
                        j = b[c];
                        if (!j.onlyShadow) {
                            o = j.color;
                            p = j.intensity;
                            ...
                            if (j instanceof THREE.AmbientLight)
                                ...
                                aa.copy(j.matrixWorld.getPosition());
                                aa.subSelf(j.target.matrixWorld.getPosition());
                                aa.normalize();
                                t[q] = aa.x;
                                t[q + 1] = aa.y;
                                t[q + 2] = aa.z;
            ...
            if (d instanceof THREE.MeshBasicMaterial || d instanceof THREE.MeshLambertMaterial ||
                ...
                F.gammaInput ? k.diffuse.value.copyGammaToLinear(d.color) : k.diffuse.value = d.color;
                ...
                if (l = f.uniforms[b[k][1]]) {
                    ...
                    switch (m) {
                        ...
                        case "f":
                            ...
                            break;
                        case "v2":
                            i.uniform2f(l, j.x, j.y);
                            break;
                        case "v3":
                            i.uniform3f(l, j.x, j.y, j.z);
                            break;
                        case "v4":
                            i.uniform4f(l, j.x, j.y, j.z, j.w);
                            break;
                        case "c":
                            i.uniform3f(l, j.r, j.g, j.b);
                            break;
                        case "fv1":
                            i.uniform1fv(l, j);
                            break;
                        ...
                        case "v2v":
                            if (!h._array)
                                h._array = new Float32Array(2 * j.length);
                            m = 0;
                            for (n = j.length; m <
                                    n; m++) {
                                r = m * 2;
                        ...
                        case "v3v":
                            if (!h._array)
                                h._array = new Float32Array(3 * j.length);
                            m = 0;
                        ...
                        case "v4v":
                            if (!h._array)
                                h._array = new Float32Array(4 * j.length);
                            m = 0;
                            for (n = j.length; m < n; m++) {
                                r = m * 4;
                                h._array[r] = j[m].x;
                        ...
                        case "m4v":
                            if (!h._array)
                                h._array = new Float32Array(16 * j.length);
                            m = 0;
                            for (n = j.length; m < n; m++)
                                j[m].flattenToArrayOffset(h._array, m * 16);
                            i.uniformMatrix4fv(l, false, h._array);
                            break;
                        case "t":
                            i.uniform1i(l, j);
                                ...
                                if (h.image.length === 6)
                                    if (h.needsUpdate) {
                                        ...
                                        y(i.TEXTURE_CUBE_MAP,
                                                h, m);
                                        for (l = 0; l < 6; l++)
                                            i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + l, 0, n, n, r, j[l]);
                                        h.generateMipmaps && m && i.generateMipmap(i.TEXTURE_CUBE_MAP);
                                        h.needsUpdate = false;
                                        if (h.onUpdate)
                                            h.onUpdate()
                                    } else {
                                        i.activeTexture(i.TEXTURE0 + j);
                                        i.bindTexture(i.TEXTURE_CUBE_MAP, h.image.__webglTextureCube)
                                    }
                        ...
                        case "tv":
                            ...
                            for (n = h.texture.length; m < n; m++)
                                (l = h.texture[m]) && F.setTexture(l, h._array[m])
                        }
                }
    ...
    function y(a, b, c) {
        if (c) {
            i.texParameteri(a, i.TEXTURE_WRAP_S, G(b.wrapS));
            i.texParameteri(a,
                    i.TEXTURE_WRAP_T, G(b.wrapT));
            i.texParameteri(a, i.TEXTURE_MAG_FILTER, G(b.magFilter));
            i.texParameteri(a, i.TEXTURE_MIN_FILTER, G(b.minFilter))
        } else {
            i.texParameteri(a, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE);
            i.texParameteri(a, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE);
            i.texParameteri(a, i.TEXTURE_MAG_FILTER, x(b.magFilter));
            i.texParameteri(a, i.TEXTURE_MIN_FILTER, x(b.minFilter))
        }
    }
    function s(a, b) {
    ...
    var a = a || {}, C = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"), z = a.precision !== void 0 ? a.precision : "highp", v = a.alpha !== void 0 ? a.alpha : true, A = a.premultipliedAlpha !== void 0 ? a.premultipliedAlpha : true, J = a.antialias !== void 0 ? a.antialias : false, L = a.stencil !== void 0 ? a.stencil :
            true, R = a.preserveDrawingBuffer !== void 0 ? a.preserveDrawingBuffer : false, P = a.clearColor !== void 0 ? new THREE.Color(a.clearColor) : new THREE.Color(0), E = a.clearAlpha !== void 0 ? a.clearAlpha : 0, M = a.maxLights !== void 0 ? a.maxLights : 4;
    this.domElement = C;
    this.context = null;
    ...
    var F = this, i, T = [], U = null, D = null, Y = -1, I = null, ea = null, fa = 0, ia = -1, O = -1, Q = -1, Z = -1, $ = -1, ha = -1, Ma = -1, Ka = -1, Ra = null, La = null, Sa = null, Na = null, Lb = 0, lb = 0, gb = 0, Mb = 0, hb = 0, Cb = 0, Wa = new THREE.Frustum,
            Ba = new THREE.Matrix4, xa = new THREE.Matrix4, $a = new THREE.Vector4, aa = new THREE.Vector3, Ta = true, Qa = {ambient: [0, 0, 0], directional: {length: 0, colors: [], positions: []}, point: {length: 0, colors: [], positions: [], distances: []}, spot: {length: 0, colors: [], positions: [], distances: [], directions: [], angles: [], exponents: []}};
    i = function() {
        var a;
        try {
            if (!(a = C.getContext("experimental-webgl", {alpha: v, premultipliedAlpha: A, antialias: J, stencil: L, preserveDrawingBuffer: R})))
    ...
    this.setSize = function(a, b) {
        C.width = a;
        C.height = b;
        this.setViewport(0, 0, C.width, C.height)
    };
    ...
    this.renderBufferImmediate = function(a, b, c) {
        ...
        if (a.hasNormal) {
            ...
            if (c === THREE.FlatShading) {
                var d, e, f, g, h, k, j, l, m, n, o = a.count * 3;
                for (n = 0; n < o; n = n + 9) {
                    c = a.normalArray;
                    d = c[n];
                    e = c[n + 1];
        ...
        if (d.visible !== false) {
            ...
            if (f instanceof THREE.Mesh) {
                ...
                for (c = f.length; d < c; ++d) {
                    ...
                    F.info.render.calls++;
                    F.info.render.vertices = F.info.render.vertices + f[d].count;
                    F.info.render.faces = F.info.render.faces + f[d].count / 3
                }
            }
        }
    };
    this.renderBuffer = function(a, b, c, d, e, f) {
        if (d.visible !== false) {
            ...
            if (!d.morphTargets && b.position >= 0) {
                ...
                if (f.morphTargetForcedOrder.length) {
                    ...
                    for (h = f.morphTargetInfluences; g <
                            d.numSupportedMorphTargets && g < k.length; ) {
                        i.bindBuffer(i.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[k[g]]);
                        i.vertexAttribPointer(c["morphTarget" + g], 3, i.FLOAT, false, 0, 0);
                        if (d.morphNormals) {
                            i.bindBuffer(i.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[k[g]]);
                            i.vertexAttribPointer(c["morphNormal" + g], 3, i.FLOAT, false, 0, 0)
                        }
                        f.__webglMorphTargetInfluences[g] = h[k[g]];
                        g++
                    }
                } else {
                    var k = [], j = -1, l = 0;
                    ...
                    var m, o = h.length;
                    g = 0;
                    for (f.morphTargetBase !== -1 && (k[f.morphTargetBase] = true); g < d.numSupportedMorphTargets; ) {
                        for (m =
                                0; m < o; m++)
                            if (!k[m] && h[m] > j) {
                                l = m;
            ...
            if (f instanceof
                ...
                F.info.render.calls++;
                F.info.render.vertices = F.info.render.vertices + e.__webglFaceCount;
                F.info.render.faces = F.info.render.faces + e.__webglFaceCount / 3
                ...
                F.info.render.calls++;
                F.info.render.points = F.info.render.points + e.__webglParticleCount
    ...
    this.render = function(a, b, c, d) {
        ...
        for (e = m.length; d < e; d++) {
            ...
            l = f.object;
            f.render = false;
            if (l.visible && (!(l instanceof THREE.Mesh || l instanceof THREE.ParticleSystem) || !l.frustumCulled ||
                    Wa.contains(l))) {
                r(l, b);
                var p = f, q = p.object, s = p.buffer, t = void 0, t = t = void 0, t = q.material;
                ...
                if (this.sortObjects)
                    if (l.renderDepth)
                        ...
                        $a.copy(l.matrixWorld.getPosition());
        ...
        if (a.overrideMaterial) {
            ...
            k(a.__webglObjects, false, "", b, n, o, true, d);
            j(a.__webglObjectsImmediate,
                    "", b, n, o, false, d)
        } else {
            this.setBlending(THREE.NormalBlending);
            k(a.__webglObjects, true, "opaque", b, n, o, false);
            j(a.__webglObjectsImmediate, "opaque", b, n, o, false);
            k(a.__webglObjects, false, "transparent", b, n, o, true);
            j(a.__webglObjectsImmediate, "transparent", b, n, o, true)
        }
    ...
    this.initWebGLObjects = function(a) {
        ...
        for (; a.__objectsAdded.length; ) {
            var g = a.__objectsAdded[0], h = a, k = void 0, j = void 0, n = void 0;
            if (!g.__webglInit) {
                g.__webglInit = true;
                ...
                if (g instanceof THREE.Mesh) {
                    ...
                    if (j instanceof THREE.Geometry) {
                        if (j.geometryGroups === void 0) {
                            var r = j, s = void 0, t = void 0, u = void 0, v = void 0, x = void 0, z = void 0, y = void 0, A = {}, D = r.morphTargets.length, E = r.morphNormals.length;
                            r.geometryGroups = {};
                            s = 0;
                            for (t = r.faces.length; s <
                                ...
                                r.geometryGroups[y] === void 0 && (r.geometryGroups[y] = {faces3: [], faces4: [], materialIndex: v, vertices: 0, numMorphTargets: D, numMorphNormals: E});
                                x = u instanceof THREE.Face3 ? 3 : 4;
                                if (r.geometryGroups[y].vertices + x > 65535) {
                                    A[z].counter = A[z].counter + 1;
                                    y = A[z].hash + "_" + A[z].counter;
                                    r.geometryGroups[y] === void 0 && (r.geometryGroups[y] = {faces3: [], faces4: [], materialIndex: v, vertices: 0, numMorphTargets: D,
                                        numMorphNormals: E})
                                }
                                u instanceof THREE.Face3 ? r.geometryGroups[y].faces3.push(s) : r.geometryGroups[y].faces4.push(s);
                                r.geometryGroups[y].vertices = r.geometryGroups[y].vertices + x
                            }
                            r.geometryGroupsList = [];
                            var I = void 0;
                            for (I in r.geometryGroups) {
                                r.geometryGroups[I].id = fa++;
                                r.geometryGroupsList.push(r.geometryGroups[I])
                            }
                        }
                        for (k in j.geometryGroups) {
                            n = j.geometryGroups[k];
                            if (!n.__webglVertexBuffer) {
                                var C = n;
                                C.__webglVertexBuffer = i.createBuffer();
                                C.__webglNormalBuffer = i.createBuffer();
                                C.__webglTangentBuffer = i.createBuffer();
                                ...
                                C.__webglSkinWeightsBuffer = i.createBuffer();
                                C.__webglFaceBuffer = i.createBuffer();
                                C.__webglLineBuffer = i.createBuffer();
                                var G = void 0, J = void 0;
                                if (C.numMorphTargets) {
                                    C.__webglMorphTargetsBuffers = [];
                                    G = 0;
                                    for (J = C.numMorphTargets; G < J; G++)
                                ...
                                if (C.numMorphNormals) {
                                    ...
                                    [];
                                    G = 0;
                                    for (J = C.numMorphNormals; G < J; G++)
                                        C.__webglMorphNormalsBuffers.push(i.createBuffer())
                                }
                                F.info.memory.geometries++;
                                var Q = n, L = g, O = L.geometry, M = Q.faces3, $ = Q.faces4, P = M.length * 3 + $.length * 4, Z = M.length * 1 + $.length * 2, Y = M.length * 3 + $.length * 4, R = c(L, Q), T = e(R), ea = d(R), ia = R.vertexColors ? R.vertexColors : false;
                    ...
                    if (!j.__webglVertexBuffer) {
                        ...
                        F.info.memory.geometries++;
                        var oa = j, xa = oa.vertices.length;
                    ...
                    if (!j.__webglVertexBuffer) {
                        ...
                        F.info.memory.geometries++;
                        var Na = j, Ta = g, Wa = Na.vertices.length;
                    ...
                    if (!j.__webglVertexBuffer) {
                        ...
                        F.info.geometries++;
                        var Qa = j, Lb = g, lb = Qa.vertices.length;
            ...
            if (!g.__webglActive) {
                if (g instanceof THREE.Mesh) {
                    ...
                    if (j instanceof THREE.BufferGeometry)
                        l(h.__webglObjects, j, g);
                    else
                        for (k in j.geometryGroups) {
                            n = j.geometryGroups[k];
                            l(h.__webglObjects, n, g)
                        }
        ...
        for (; a.__objectsRemoved.length; ) {
            ...
            bb instanceof THREE.Mesh || bb instanceof THREE.ParticleSystem || bb instanceof THREE.Ribbon || bb instanceof THREE.Line ? p(gb.__webglObjects, bb) : bb instanceof THREE.Sprite ? q(gb.__webglSprites, bb) : bb instanceof THREE.LensFlare ?
                    q(gb.__webglFlares, bb) : (bb instanceof THREE.ImmediateRenderObject || bb.immediateRenderCallback) && p(gb.__webglObjectsImmediate, bb);
            bb.__webglActive = false;
            a.__objectsRemoved.splice(0, 1)
        }
        for (var ib = 0, Mb = a.__webglObjects.length; ib < Mb; ib++) {
            var jb = a.__webglObjects[ib].object, ga = jb.geometry, hb = void 0, jc = void 0, Ua = void 0;
            if (jb instanceof THREE.Mesh)
                    ...
                    for (var Cb = 0, nd = ga.geometryGroupsList.length; Cb < nd; Cb++) {
                        ...
                        if (ga.verticesNeedUpdate || ga.morphTargetsNeedUpdate || ga.elementsNeedUpdate || ga.uvsNeedUpdate || ga.normalsNeedUpdate || ga.colorsNeedUpdate || ga.tangetsNeedUpdate || jc) {
                            ...
                            if (ca.__inittedArrays) {
                                ...
                                if (ud) {
                                    Ea = 0;
                                    for (fd = Zb.length; Ea < fd; Ea++) {
                                        H = ba = 0;
                                        for (S = ka.length; H < S; H++) {
                                            Xb = ka[H];
                                            N = za[Xb];
                                            V = Zb[Ea].vertices[N.a];
                                            W = Zb[Ea].vertices[N.b];
                                            X = Zb[Ea].vertices[N.c];
                                            Ca = Uc[Ea];
                                            Ca[ba] = V.x;
                                            Ca[ba +
                                            1] = V.y;
                                            ...
                                            if (cc.morphNormals) {
                                                if (Ec) {
                                                    Hb = Ic[Ea].vertexNormals[Xb];
                                                    pb = Hb.a;
                                                    qb = Hb.b;
                                                    rb = Hb.c
                                                } else
                                                    rb = qb = pb = Ic[Ea].faceNormals[Xb];
                                                Da = Vc[Ea];
                                                Da[ba] = pb.x;
                                                Da[ba + 1] = pb.y;
                                                Da[ba + 2] = pb.z;
                                        ...
                                        H = 0;
                                        for (S = la.length; H < S; H++) {
                                            Xb = la[H];
                                            N = za[Xb];
                                            V = Zb[Ea].vertices[N.a];
                                            W = Zb[Ea].vertices[N.b];
                                            X = Zb[Ea].vertices[N.c];
                                            ma = Zb[Ea].vertices[N.d];
                                            Ca = Uc[Ea];
                                            Ca[ba] = V.x;
                                            Ca[ba + 1] = V.y;
                                            Ca[ba + 2] = V.z;
                                            ...
                                            if (cc.morphNormals) {
                                                if (Ec) {
                                                    ...
                                                    rc = rb = qb = pb = Ic[Ea].faceNormals[Xb];
                                                Da = Vc[Ea];
                                                Da[ba] = pb.x;
                                                Da[ba + 1] = pb.y;
                                                Da[ba + 2] = pb.z;
                                ...
                                if (Wc) {
                                    ...
                                    for (ed = Wc.length; ja < ed; ja++) {
                                        w = Wc[ja];
                                        if (w.__original.needsUpdate) {
                                            B = 0;
                                            if (w.size === 1)
                                                if (w.boundTo === void 0 || w.boundTo === "vertices") {
                                                    H = 0;
                                                    for (S = ka.length; H <
                                                            S; H++) {
                                                        N = za[ka[H]];
                                                        w.array[B] = w.value[N.a];
                                                        w.array[B + 1] = w.value[N.b];
                                                        w.array[B + 2] = w.value[N.c];
                                                        B = B + 3
                                                    }
                                                    H = 0;
                                                    for (S = la.length; H < S; H++) {
                                                ...
                                                if (w.boundTo === void 0 || w.boundTo === "vertices") {
                                                    ...
                                                    for (S = la.length; H < S; H++) {
                                                        ...
                                                        w.array[B + 8] = X[da[2]];
                                                        w.array[B + 9] = ma[da[0]];
                                                        w.array[B + 10] = ma[da[1]];
                                                        w.array[B + 11] = ma[da[2]];
                                                        B = B + 12
                                                    }
                                                } else if (w.boundTo === "faces") {
                                                    H = 0;
                                                    for (S = ka.length; H < S; H++) {
                                                        X = W = V = Ya = w.value[ka[H]];
                                                        w.array[B] = V[da[0]];
                                            ...
                                            i.bindBuffer(i.ARRAY_BUFFER, w.buffer);
                                            i.bufferData(i.ARRAY_BUFFER, w.array, Xa)
                                        }
                                    }
                                }
                                if (pd) {
                ...
                if (ga.verticesNeedUpdate || ga.colorsNeedUpdate) {
                    var $b = ga, hd = i.DYNAMIC_DRAW, xc = void 0, yc = void 0, Jc = void 0, ac = void 0, Kc = void 0, id = $b.vertices, jd = $b.colors, vd = id.length, wd = jd.length, Lc = $b.__vertexArray, Mc = $b.__colorArray, xd = $b.colorsNeedUpdate;
                    if ($b.verticesNeedUpdate) {
                        ...
                        i.bindBuffer(i.ARRAY_BUFFER, $b.__webglVertexBuffer);
                    ...
                    if (xd) {
                        ...
                        i.bindBuffer(i.ARRAY_BUFFER, $b.__webglColorBuffer);
                ...
                Ua = c(jb, hb);
                jc = Ua.attributes && o(Ua);
                if (ga.verticesNeedUpdate || ga.colorsNeedUpdate || jc) {
                    var Kb =
                            ga, Zc = i.DYNAMIC_DRAW, zc = void 0, Ac = void 0, Nc = void 0, va = void 0, Oc = void 0, kd = Kb.vertices, ld = Kb.colors, yd = kd.length, zd = ld.length, Pc = Kb.__vertexArray, Qc = Kb.__colorArray, Ad = Kb.colorsNeedUpdate, $c = Kb.__webglCustomAttributesList, Rc = void 0, md = void 0, Ia = void 0, pc = void 0, Va = void 0, pa = void 0;
                    if (Kb.verticesNeedUpdate) {
                        for (zc = 0; zc < yd; zc++) {
                            Nc = kd[zc];
                            va = zc * 3;
                            Pc[va] = Nc.x;
                        ...
                        i.bindBuffer(i.ARRAY_BUFFER, Kb.__webglVertexBuffer);
                    ...
                    if (Ad) {
                        ...
                        i.bindBuffer(i.ARRAY_BUFFER, Kb.__webglColorBuffer);
                ...
                Ua = c(jb, hb);
                jc = Ua.attributes && o(Ua);
                (ga.verticesNeedUpdate || ga.colorsNeedUpdate || jb.sortParticles || jc) && f(ga, i.DYNAMIC_DRAW, jb);
                ga.verticesNeedUpdate = false;
                ga.colorsNeedUpdate = false;
                Ua.attributes && m(Ua)
            }
    ...
    this.initMaterial = function(a, b, c, d) {
        ...
        a:{
            ...
            r = i.createProgram();
            d = ["precision " + z + " float;", oa > 0 ? "#define VERTEX_TEXTURES" : "", F.gammaInput ? "#define GAMMA_INPUT" : "", F.gammaOutput ? "#define GAMMA_OUTPUT" : "", F.physicallyBasedShading ? "#define PHYSICALLY_BASED_SHADING" : "", "#define MAX_DIR_LIGHTS " + c.maxDirLights, "#define MAX_POINT_LIGHTS " + c.maxPointLights, "#define MAX_SPOT_LIGHTS " + c.maxSpotLights, "#define MAX_SHADOWS " + c.maxShadows, "#define MAX_BONES " +
            ...
            i.attachShader(r, t("fragment", j + n));
            i.attachShader(r, t("vertex", d + k));
            i.linkProgram(r);
            ...
            F.info.memory.programs = T.length;
            q = r
        }
        a.program = q;
    ...
    this.setTexture = function(a, b) {
        if (a.needsUpdate) {
            ...
            i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,
                    a.premultiplyAlpha);
            var c = a.image, d = (c.width & c.width - 1) === 0 && (c.height & c.height - 1) === 0, e = G(a.format), f = G(a.type);
            y(i.TEXTURE_2D, a, d);
    ...
    this.setRenderTarget = function(a) {
        ...
        if (a && !a.__webglFramebuffer) {
            ...
            a.__webglTexture = i.createTexture();
            var c = (a.width & a.width - 1) === 0 && (a.height & a.height - 1) === 0, d = G(a.format), e = G(a.type);
            if (b) {
...
THREE.GeometryUtils = {merge: function(a, b) {
        for (var c, d, e = a.vertices.length, f = b instanceof THREE.Mesh ? b.geometry : b, g = a.vertices, h = f.vertices, k = a.faces, j = f.faces, l = a.faceVertexUvs[0], o = f.faceVertexUvs[0], m = {}, p = 0; p < a.materials.length; p++)
            m[a.materials[p].id] = p;
        ...
        p = 0;
        for (q = j.length; p < q; p++) {
            var g =
                    j[p], r, u, t = g.vertexNormals, y = g.vertexColors;
        ...
        var d, e, f = a.faces, g = a.vertices, h = f.length, k = 0, j = [], l, o, m, p;
        for (e = 0; e < h; e++) {
            d = f[e];
            if (d instanceof THREE.Face3) {
                l = g[d.a];
                o = g[d.b];
                m = g[d.c];
                d._area = THREE.GeometryUtils.triangleArea(l, o, m)
            } else if (d instanceof THREE.Face4) {
                l =
                        g[d.a];
                o = g[d.b];
                m = g[d.c];
                p = g[d.d];
                d._area1 = THREE.GeometryUtils.triangleArea(l, o, p);
                d._area2 = THREE.GeometryUtils.triangleArea(o, m, p);
        ...
        d = [];
        for (e = 0; e < b; e++) {
            g = THREE.GeometryUtils.random() * k;
            g = c(g);
        ...
        for (c = a.faces.length; b < c; b++) {
            ...
            if (d instanceof THREE.Face4) {
                e = d.a;
                var k = d.b, j = d.c, l = d.d, o = new THREE.Face3, m = new THREE.Face3;
                o.color.copy(d.color);
                ...
                if (d.vertexColors.length === 4) {
                    o.vertexColors[0] = d.vertexColors[0].clone();
                    o.vertexColors[1] = d.vertexColors[1].clone();
                    o.vertexColors[2] = d.vertexColors[3].clone();
                ...
                for (e = a.faceVertexUvs.length; d < e; d++)
                    if (a.faceVertexUvs[d].length) {
                        o = a.faceVertexUvs[d][b];
                        k = o[1];
                        j = o[2];
                        l = o[3];
                        o = [o[0].clone(), k.clone(), l.clone()];
                        k = [k.clone(), j.clone(), l.clone()];
                        h[d].push(o, k)
                    }
                d = 0;
        ...
        for (var b = [], c = 0, d = a.faces.length; c < d; c++) {
            ...
            if (f instanceof THREE.Face4) {
                var g = f.a, h = f.b, k = f.c, g = a.vertices[g], h = a.vertices[h], k = a.vertices[k], j = a.vertices[f.d];
                b.push(g.clone());
                b.push(h.clone());
                b.push(k.clone());
                b.push(j.clone());
        ...
        var c, d, e, f, g, h, k, j, l, o, m, p, q, n, r, u, t, y, s, x = [], G = [];
        c = 0;
                    ...
                    for (g = a.faceVertexUvs.length; f < g; f++)
                        if (a.faceVertexUvs[f].length) {
                            ...
                            if (e ===
                                ...
                                l = s.clone();
                                l.lerpSelf(h, 0.5);
                                j = [s.clone(), l.clone(), y.clone()];
                                h = [l.clone(), h.clone(), y.clone()]
                            } else if (e === 1) {
                                l = h.clone();
                                l.lerpSelf(y, 0.5);
                                j = [s.clone(), h.clone(), l.clone()];
                                h = [l.clone(), y.clone(), s.clone()]
                            } else {
                                l = s.clone();
                                l.lerpSelf(y, 0.5);
                                j = [s.clone(), h.clone(), l.clone()];
                    ...
                    for (g = a.faceVertexUvs.length; f < g; f++)
                        if (a.faceVertexUvs[f].length) {
                            ...
                            if (e === 0) {
                                ...
                                o = y.clone();
                                o.lerpSelf(j, 0.5);
                                s = [s.clone(), l.clone(), o.clone(), j.clone()];
                                h = [l.clone(), h.clone(), y.clone(), o.clone()]
                            } else {
                                l = h.clone();
                                l.lerpSelf(y, 0.5);
                                o = j.clone();
                                o.lerpSelf(s, 0.5);
                                s = [s.clone(), h.clone(), l.clone(), o.clone()];
                                h = [o.clone(), l.clone(), y.clone(), j.clone()]
                            }
                            G[f].push(s, h)
                        }
                } else {
...
THREE.ImageUtils = {crossOrigin: "anonymous", loadTexture: function(a, b, c) {
        ...
        g.drawImage(a, 0, 0);
        for (var h = g.getImageData(0, 0, d, e).data, k = g.createImageData(d, e), j = k.data, l = 0; l < d; l++)
            for (var o = 0; o < e; o++) {
                var m = o - 1 < 0 ? 0 : o - 1, p = o + 1 > e - 1 ? e - 1 : o + 1, q = l - 1 < 0 ? 0 : l - 1, n = l + 1 > d - 1 ? d - 1 : l + 1, r = [], u = [0, 0, h[(o * d + l) * 4] / 255 * b];
                r.push([-1, 0, h[(o * d + q) * 4] / 255 * b]);
                r.push([-1, -1, h[(m * d + q) * 4] / 255 * b]);
                r.push([0,
                    -1, h[(m * d + l) * 4] / 255 * b]);
                r.push([1, -1, h[(m * d + n) * 4] / 255 * b]);
                r.push([1, 0, h[(o * d + n) * 4] / 255 * b]);
                r.push([1, 1, h[(p * d + n) * 4] / 255 * b]);
                r.push([0, 1, h[(p * d + l) * 4] / 255 * b]);
                r.push([-1, 1, h[(p * d + q) * 4] / 255 * b]);
                m = [];
                q = r.length;
                for (p = 0; p < q; p++) {
                    var n = r[p], t = r[(p + 1) % q], n = [n[0] - u[0], n[1] - u[1], n[2] - u[2]], t = [t[0] - u[0], t[1] - u[1], t[2] - u[2]];
...
THREE.CurvePath.prototype.getBoundingBox = function() {
    ...
    return{minX: d, minY: e, maxX: b, maxY: c, centroid: k.divideScalar(h)}
};
...
THREE.CurvePath.prototype.getWrapPoints = function(a, b) {
    ...
    for (e = a.length; d < e; d++) {
        ...
        g = b.getPoint(k);
        h = b.getNormalVector(k).multiplyScalar(h);
        f.x = g.x + h.x;
        f.y = g.y + h.y
    }
    return a
...
THREE.Path.prototype.getPoints = function(a, b) {
    ...
    var a = a || 12, c = [], d, e, f, g, h, k, j, l, o, m, p, q, n;
    d = 0;
    for (e = this.actions.length; d < e; d++) {
        ...
        switch (g) {
            ...
            case THREE.PathActions.QUADRATIC_CURVE_TO:
                ...
                for (f = 1; f <= a; f++) {
                    n = f / a;
                    g = THREE.Shape.Utils.b2(n, p, o, h);
                    n = THREE.Shape.Utils.b2(n, q, m, k);
            ...
            case THREE.PathActions.BEZIER_CURVE_TO:
                ...
                for (f = 1; f <= a; f++) {
                    n = f / a;
                    g = THREE.Shape.Utils.b3(n, p, o, j, h);
                    n = THREE.Shape.Utils.b3(n, q, m, l, k);
...
THREE.Path.prototype.nltransform = function(a, b, c, d, e, f) {
    var g = this.getPoints(), h, k, j, l, o;
    h = 0;
...
THREE.Shape.Utils = {removeHoles: function(a, b) {
        var c = a.concat(), d = c.concat(), e, f, g, h, k, j, l, o, m, p, q = [];
        for (k = 0; k < b.length; k++) {
            ...
            q.push([j[g], c[h], c[e]]);
            q.push(f);
            c = o.concat(p).concat(l).concat(m)
        }
        return{shape: c,
            isolatedPts: q, allpoints: d}
    }, triangulateShape: function(a, b) {
        var c = THREE.Shape.Utils.removeHoles(a, b), d = c.allpoints, e = c.isolatedPts, c = THREE.FontUtils.Triangulate(c.shape, false), f, g, h, k, j = {};
        f = 0;
        for (g = d.length; f < g; f++) {
            k = d[f].x + ":" + d[f].y;
            j[k] !== void 0 && console.log("Duplicate point", k);
            j[k] = f
        }
        f = 0;
                    ...
                    if (a.hierarchy[c].keys.length && a.hierarchy[c].keys[0].morphTargets !== void 0) {
                        ...
                        for (d = 0; d < a.hierarchy[c].keys.length; d++)
                            for (var k = 0; k < a.hierarchy[c].keys[d].morphTargets.length; k++) {
                                var j = a.hierarchy[c].keys[d].morphTargets[k];
                                h[j] = -1
                            }
                        ...
                        for (d = 0; d < a.hierarchy[c].keys.length; d++) {
                            ...
                            for (j in h) {
                                for (k = 0; k < a.hierarchy[c].keys[d].morphTargets.length; k++)
                                    if (a.hierarchy[c].keys[d].morphTargets[k] === j) {
                                        l[j] = a.hierarchy[c].keys[d].morphTargetsInfluences[k];
                                        break
                                    }
                                k === a.hierarchy[c].keys[d].morphTargets.length && (l[j] = 0)
                            }
...
THREE.Animation.prototype.update = function(a) {
    if (this.isPlaying) {
        var b = ["pos", "rot", "scl"], c, d, e, f, g, h, k, j, l = this.data.JIT.hierarchy, o, m;
        m = this.currentTime = this.currentTime + a * this.timeScale;
        o = this.currentTime = this.currentTime % this.data.length;
        j = parseInt(Math.min(o * this.data.fps, this.data.length * this.data.fps), 10);
        for (var p = 0, q = this.hierarchy.length; p < q; p++) {
            a = this.hierarchy[p];
            k = a.animationCache;
            if (this.JITCompile && l[p][j] !== void 0)
                ...
                for (var n = 0; n < 3; n++) {
                    ...
                    if (h.time <= m) {
                        if (o < m)
                            if (this.loop) {
                                ...
                                for (h = this.getNextKeyWith(c, p, 1); h.time < o; ) {
                                    g = h;
                    ...
                    a.matrixWorldNeedsUpdate = true;
                    d = (o - g.time) / (h.time - g.time);
                    e = g[c];
                    f = h[c];
                    if (d < 0 || d > 1) {
                        console.log("THREE.Animation.update: Warning! Scale out of bounds:" + d + " on bone " + p);
                        d = d < 0 ? 0 : 1
                    }
                    if (c === "pos") {
                        c = a.position;
        ...
        if (this.JITCompile && l[0][j] === void 0) {
            this.hierarchy[0].updateMatrixWorld(true);
            for (p = 0; p < this.hierarchy.length; p++)
                l[p][j] = this.hierarchy[p]instanceof THREE.Bone ? this.hierarchy[p].skinMatrix.clone() : this.hierarchy[p].matrix.clone()
        }
    }
};
THREE.Animation.prototype.interpolateCatmullRom = function(a, b) {
    ...
    c = e * e;
    g = e * c;
    d[0] = this.interpolate(f[0], h[0], k[0], j[0], e, c, g);
    d[1] = this.interpolate(f[1], h[1], k[1], j[1], e, c, g);
    d[2] = this.interpolate(f[2], h[2], k[2], j[2], e, c, g);
    return d
};
...
THREE.KeyFrameAnimation.prototype.update = function(a) {
    if (this.isPlaying) {
        var b, c, d, e, f = this.data.JIT.hierarchy, g, h, k;
        ...
        if ((k = g < h) && !this.loop) {
            ...
            for (j = this.hierarchy.length; a < j; a++) {
                ...
                var l = b.keys, o = b.animationCache;
                if (this.JITCompile && f[a][e] !== void 0)
                    ...
                    if (this.JITCompile && o)
                        d instanceof THREE.Bone ? d.skinMatrix = o.originalMatrix : d.matrix = o.originalMatrix;
                    b = o.prevKey;
                    c = o.nextKey;
                    if (b && c) {
                        if (c.time <= h) {
...
THREE.PathControls = function(a, b) {
    ...
    this.init = function() {
        ...
        if (this.createDebugPath) {
            ...
            c.scale.set(1, 1, 1);
            a.add(c);
            for (var g = new THREE.SphereGeometry(1, 16, 8), h = new THREE.MeshBasicMaterial({color: 65280}), p = 0; p < b.points.length; p++) {
...
THREE.RollControls = function(a, b) {
    ...
    this.roll = 0;
    var c = new THREE.Vector3, d = new THREE.Vector3, e = new THREE.Vector3, f = new THREE.Matrix4, g = false, h = 1, k = 0, j = 0, l = 0, o = 0, m = 0, p = window.innerWidth / 2, q = window.innerHeight / 2;
    this.update = function(a) {
        if (this.mouseLook) {
            var b =
                    a * this.lookSpeed;
            this.rotateHorizontally(b * o);
            this.rotateVertically(b * m)
        }
        b = a * this.movementSpeed;
        this.object.translateZ(-b * (k > 0 || this.autoForward && !(k < 0) ? 1 : k));
    ...
    this.domElement.addEventListener("mousemove", function(a) {
        o = (a.clientX - p) / window.innerWidth;
...
THREE.TrackballControls = function(a, b) {
    ...
    this.keys = [65, 83, 68];
    this.target = new THREE.Vector3;
    var d = new THREE.Vector3, e = false, f = -1, g = new THREE.Vector3, h = new THREE.Vector3, k = new THREE.Vector3, j = new THREE.Vector2, l = new THREE.Vector2, o = new THREE.Vector2, m = new THREE.Vector2, p = {type: "change"};
    this.handleEvent = function(a) {
        if (typeof this[a.type] == "function")
            this[a.type](a)
    };
    ...
    this.rotateCamera = function() {
        var a = Math.acos(h.dot(k) / h.length() / k.length());
        if (a) {
            var b = (new THREE.Vector3).cross(h, k).normalize(), d = new THREE.Quaternion, a = a * c.rotateSpeed;
    ...
    this.zoomCamera = function() {
        ...
        if (a !== 1 && a > 0) {
            g.multiplyScalar(a);
            c.staticMoving ? j = l : j.y = j.y + (l.y - j.y) * this.dynamicDampingFactor
        }
    };
    this.panCamera = function() {
        var a = m.clone().subSelf(o);
        if (a.lengthSq()) {
            ...
            c.target.addSelf(b);
            c.staticMoving ? o = m : o.addSelf(a.sub(m, o).multiplyScalar(c.dynamicDampingFactor))
        }
    };
    ...
    this.domElement.addEventListener("mousemove", function(a) {
        if (c.enabled) {
            if (e) {
                h = k = c.getMouseProjectionOnBall(a.clientX, a.clientY);
                j = l = c.getMouseOnScreen(a.clientX, a.clientY);
                o =
                        m = c.getMouseOnScreen(a.clientX, a.clientY);
                e = false
            }
            f !== -1 && (f === 0 && !c.noRotate ? k = c.getMouseProjectionOnBall(a.clientX, a.clientY) : f === 1 && !c.noZoom ? l = c.getMouseOnScreen(a.clientX, a.clientY) : f === 2 && !c.noPan && (m = c.getMouseOnScreen(a.clientX, a.clientY)))
        }
    }, false);
    this.domElement.addEventListener("mousedown", function(a) {
        if (c.enabled) {
            ...
            if (f === -1) {
                f = a.button;
                f === 0 && !c.noRotate ? h = k = c.getMouseProjectionOnBall(a.clientX, a.clientY) : f === 1 && !c.noZoom ? j = l = c.getMouseOnScreen(a.clientX,
                        a.clientY) : this.noPan || (o = m = c.getMouseOnScreen(a.clientX, a.clientY))
            }
        }
    }, false);
    this.domElement.addEventListener("mouseup", function(a) {
...
THREE.CubeGeometry = function(a, b, c, d, e, f, g, h) {
    function k(a, b, c, g, h, k, l, m) {
        var n, o = d || 1, p = e || 1, q = h / 2, r = k / 2, t = j.vertices.length;
        if (a === "x" && b === "y" || a === "y" && b === "x")
            n = "z";
        ...
        var i = o + 1, u = p + 1, y = h / o, D = k / p, Y = new THREE.Vector3;
        Y[n] = l > 0 ? 1 : -1;
        for (h = 0; h < u; h++)
            for (k = 0; k < i; k++) {
        ...
        for (h = 0; h < p; h++)
            for (k = 0; k < o; k++) {
                a = new THREE.Face4(k +
                        i * h + t, k + i * (h + 1) + t, k + 1 + i * (h + 1) + t, k + 1 + i * h + t);
                a.normal.copy(Y);
                a.vertexNormals.push(Y.clone(), Y.clone(), Y.clone(), Y.clone());
                a.materialIndex = m;
                j.faces.push(a);
                j.faceVertexUvs[0].push([new THREE.UV(k / o, h / p), new THREE.UV(k / o, (h + 1) / p), new THREE.UV((k + 1) / o, (h + 1) / p), new THREE.UV((k + 1) / o, h / p)])
            }
    }
    THREE.Geometry.call(this);
    var j = this, l = a / 2, o = b / 2, m = c / 2, p, q, n, r, u, t;
    if (g !== void 0) {
    ...
    this.sides.px && k("z", "y", -1, -1, c, b, l, p);
    this.sides.nx && k("z", "y", 1, -1, c, b, -l, r);
    this.sides.py && k("x", "z", 1, 1, a, c, o, q);
    this.sides.ny && k("x", "z", 1, -1, a, c, -o, u);
    this.sides.pz && k("x", "y", 1, -1, a, b, m, n);
    this.sides.nz && k("x", "y", -1, -1, a, b, -m, t);
    this.computeCentroids();
    this.mergeVertices()
};
...
THREE.CylinderGeometry = function(a, b, c, d, e, f) {
    THREE.Geometry.call(this);
    var a = a !== void 0 ? a : 20, b = b !== void 0 ? b : 20, c = c !== void 0 ? c : 100, g = c / 2, d = d || 8, e = e || 1, h, k, j = [], l = [];
    for (k = 0; k <= e; k++) {
        var o = [], m = [], p = k / e, q = p * (b - a) + a;
        for (h = 0; h <= d; h++) {
    ...
    for (h = 0; h < d; h++) {
        if (a !== 0) {
            o = this.vertices[j[0][h]].clone();
            m = this.vertices[j[0][h +
            1]].clone()
        } else {
            o = this.vertices[j[1][h]].clone();
            m = this.vertices[j[1][h + 1]].clone()
        }
        o.setY(Math.sqrt(o.x * o.x + o.z * o.z) * c).normalize();
        m.setY(Math.sqrt(m.x * m.x + m.z * m.z) * c).normalize();
        for (k = 0; k < e; k++) {
            var p = j[k][h], q = j[k + 1][h], n = j[k + 1][h + 1], r = j[k][h + 1], u = o.clone(), t = o.clone(), y = m.clone(), s = m.clone(), x = l[k][h].clone(), G = l[k + 1][h].clone(), C = l[k + 1][h + 1].clone(), z = l[k][h + 1].clone();
            this.faces.push(new THREE.Face4(p, q, n, r, [u, t, y, s]));
            this.faceVertexUvs[0].push([x, G, C, z])
        }
    }
    if (!f && a > 0) {
        ...
        for (h = 0; h < d; h++) {
            ...
            x = l[0][h].clone();
            G = l[0][h + 1].clone();
            C = new THREE.UV(G.u, 0);
            this.faces.push(new THREE.Face3(p, q, n, [u, t, y]));
            this.faceVertexUvs[0].push([x, G, C])
        }
    }
    if (!f && b > 0) {
...
THREE.ExtrudeGeometry.prototype.addShape = function(a, b) {
    ...
    function e(c, d) {
        ...
        for (I = c.length; --I >= 0; ) {
            ...
            for (var g = 0, h = m + l * 2, g = 0; g < h; g++) {
                var i = U * g, k = U * (g + 1), j = d + e + i, i = d + f + i, n = d + f + k, k = d + e + k, o = c, p = g, q = h, j = j + J, i = i + J, n = n + J, k = k + J;
                A.faces.push(new THREE.Face4(j, i, n, k, null, null, t));
                j = O.generateSideWallUV(A, a, o, b, j, i, n, k, p, q);
                A.faceVertexUvs[0].push(j)
            }
        }
    }
    function f(a, b, c) {
    ...
    var h =
            b.amount !== void 0 ? b.amount : 100, k = b.bevelThickness !== void 0 ? b.bevelThickness : 6, j = b.bevelSize !== void 0 ? b.bevelSize : k - 2, l = b.bevelSegments !== void 0 ? b.bevelSegments : 3, o = b.bevelEnabled !== void 0 ? b.bevelEnabled : true, m = b.steps !== void 0 ? b.steps : 1, p = b.bendPath, q = b.extrudePath, n, r = false, u = b.material, t = b.extrudeMaterial, y, s, x, G;
    if (q) {
    ...
    p && a.addWrapPath(p);
    var q = a.extractPoints(), p = q.shape, L = q.holes;
    if (q = !THREE.Shape.Utils.isClockWise(p)) {
        p = p.reverse();
        z = 0;
        for (v = L.length; z < v; z++) {
            C = L[z];
            THREE.Shape.Utils.isClockWise(C) && (L[z] = C.reverse())
        }
        q = false
    }
    var R = THREE.Shape.Utils.triangulateShape(p, L), P = p;
    z = 0;
    for (v = L.length; z < v; z++) {
        C = L[z];
        p = p.concat(C)
    }
    var E, M, F, i, T, U = p.length, D, Y = R.length, q = [], I = 0;
    F = P.length;
    E = F - 1;
    for (M = I + 1; I < F; I++, E++, M++) {
        E === F && (E = 0);
    ...
    for (E = 0; E < l; E++) {
        F = E / l;
        i = k * (1 - F);
        M = j * Math.sin(F * Math.PI / 2);
        I = 0;
        for (F = P.length; I < F; I++) {
            T = c(P[I], q[I], M);
            f(T.x, T.y, -i)
        }
        z = 0;
    ...
    for (F = 1; F <= m; F++)
        for (I = 0; I < U; I++) {
            T = o ? c(p[I], ia[I], M) : p[I];
            if (r) {
                x.copy(y.normals[F]).multiplyScalar(T.x);
                s.copy(y.binormals[F]).multiplyScalar(T.y);
                G.copy(n[F]).addSelf(x).addSelf(s);
                f(G.x, G.y, G.z)
            } else
                f(T.x, T.y, h / m * F)
        }
    ...
    (function() {
        if (o) {
            ...
            for (I = 0; I < Y; I++) {
                D = R[I];
                g(D[2] + a, D[1] + a, D[0] + a, true)
            }
            a = m + l * 2;
            a = U * a;
            for (I = 0; I < Y; I++) {
                D = R[I];
                g(D[0] + a, D[1] + a, D[2] + a, false)
            }
        } else {
            for (I = 0; I < Y; I++) {
                D = R[I];
            ...
            for (I = 0; I < Y; I++) {
                D = R[I];
                g(D[0] + U * m, D[1] + U * m, D[2] + U * m, false)
            }
        }
    })();
    (function() {
...
THREE.ExtrudeGeometry.WorldUVGenerator = {generateTopUV: function(a, b, c, d, e, f) {
        ...
        var b = a.vertices[e].x, c = a.vertices[e].y, e = a.vertices[e].z, d = a.vertices[f].x, k = a.vertices[f].y, f = a.vertices[f].z, j = a.vertices[g].x, l =
                a.vertices[g].y, g = a.vertices[g].z, o = a.vertices[h].x, m = a.vertices[h].y, a = a.vertices[h].z;
        return Math.abs(c - k) < 0.01 ? [new THREE.UV(b, e), new THREE.UV(d, f), new THREE.UV(j, g), new THREE.UV(o, a)] : [new THREE.UV(c, e), new THREE.UV(k, f), new THREE.UV(l, g), new THREE.UV(m, a)]
    }};
...
THREE.PlaneGeometry = function(a, b, c, d) {
    THREE.Geometry.call(this);
    for (var e = a / 2, f = b / 2, c = c || 1, d = d || 1, g = c + 1, h = d + 1, k = a / c, j = b / d, l = new THREE.Vector3(0, 1, 0), a = 0; a < h; a++)
        for (b = 0; b < g; b++)
            this.vertices.push(new THREE.Vector3(b * k - e, 0, a * j - f));
    for (a = 0; a < d; a++)
        for (b = 0; b < c; b++) {
...
THREE.SphereGeometry = function(a, b, c, d, e, f, g) {
    THREE.Geometry.call(this);
    var a = a || 50, d = d !== void 0 ? d : 0, e = e !== void 0 ? e : Math.PI * 2, f = f !== void 0 ? f : 0, g = g !== void 0 ? g : Math.PI, b = Math.max(3, Math.floor(b) || 8), c = Math.max(2, Math.floor(c) || 6), h, k, j = [], l = [];
    for (k = 0; k <= c; k++) {
        var o = [], m = [];
        for (h = 0; h <= b; h++) {
            var p = h / b, q = k / c, n = new THREE.Vector3;
            n.x = -a * Math.cos(d + p * e) * Math.sin(f + q * g);
            n.y = a * Math.cos(f + q * g);
            n.z = a * Math.sin(d + p * e) * Math.sin(f + q * g);
            this.vertices.push(n);
            o.push(this.vertices.length - 1);
            m.push(new THREE.UV(p,
                    q))
        }
        j.push(o);
        l.push(m)
    ...
    for (k = 0; k < c; k++)
        for (h = 0; h < b; h++) {
            var d = j[k][h + 1], e = j[k][h], f = j[k + 1][h], g = j[k + 1][h + 1], o = this.vertices[d].clone().normalize(), m = this.vertices[e].clone().normalize(), p = this.vertices[f].clone().normalize(), q = this.vertices[g].clone().normalize(), n = l[k][h + 1].clone(), r = l[k][h].clone(), u = l[k + 1][h].clone(), t = l[k + 1][h + 1].clone();
            if (Math.abs(this.vertices[d].y) == a) {
                this.faces.push(new THREE.Face3(d, f, g, [o, p, q]));
                this.faceVertexUvs[0].push([n, u, t])
            } else if (Math.abs(this.vertices[f].y) ==
                    a) {
                this.faces.push(new THREE.Face3(d, e, f, [o, m, p]));
                this.faceVertexUvs[0].push([n, r, u])
            } else {
                this.faces.push(new THREE.Face4(d, e, f, g, [o, m, p, q]));
...
THREE.FontUtils = {faces: {}, face: "helvetiker", weight: "normal", style: "normal", size: 150, divisions: 10, getFace: function() {
        ...
        var f = [], g, h, k, j, l, o, m, p, q, n, r, u = b.glyphs[a] || b.glyphs["?"];
        if (u) {
            if (u.o) {
                ...
                for (a = 0; a < j; ) {
                    ...
                    switch (k) {
                        ...
                        case "q":
                            ...
                            p = b[a++] * c + d;
                            q = b[a++] * c;
                            e.quadraticCurveTo(p, q, k, l);
                            if (g = f[f.length - 1]) {
                                o = g.x;
                                m = g.y;
                                g = 1;
                                for (h = this.divisions; g <= h; g++) {
                                    var t = g / h, y = THREE.Shape.Utils.b2(t, o, p, k), t = THREE.Shape.Utils.b2(t, m, q, l);
                        ...
                        case "b":
                            ...
                            if (g = f[f.length - 1]) {
                                ...
                                for (h = this.divisions; g <= h; g++) {
                                    t = g / h;
                                    y = THREE.Shape.Utils.b3(t, o, p,
                                            n, k);
                                    t = THREE.Shape.Utils.b3(t, m, q, r, l);
                                    f.push(new THREE.Vector2(y, t))
                                }
                            }
                        }
...
(function(a) {
    ...
    a.Triangulate = function(a, d) {
        ...
        for (j = e - 1; e > 2; ) {
            ...
            a:{
                m = a;
                var p = k, q = j, n = l, r = e, u = g, t = void 0, y = void 0, s = void 0, x = void 0, G = void 0,
                        C = void 0, z = void 0, v = void 0, A = void 0, y = m[u[p]].x, s = m[u[p]].y, x = m[u[q]].x, G = m[u[q]].y, C = m[u[n]].x, z = m[u[n]].y;
                if (1.0E-10 > (x - y) * (z - s) - (G - s) * (C - y))
                    m = false;
                else {
                    for (t = 0; t < r; t++)
                        if (!(t == p || t == q || t == n)) {
                            var v = m[u[t]].x, A = m[u[t]].y, J = void 0, L = void 0, R = void 0, P = void 0, E = void 0, M = void 0, F = void 0, i = void 0, T = void 0, U = void 0, D = void 0, Y = void 0, J = R = E = void 0, J = C - x, L = z - G, R = y - C, P = s - z, E = x - y, M = G - s, F = v - y, i = A - s, T = v - x, U = A - G, D = v - C, Y = A - z, J = J * U - L * T, E = E * i - M * F, R = R * Y - P * D;
                            if (J >= 0 && R >= 0 && E >= 0) {
                                m = false;
                                break a
                            }
...
THREE.TorusGeometry = function(a, b, c, d, e) {
    ...
    for (c = 1; c <= this.segmentsR; c++)
        for (d = 1; d <= this.segmentsT; d++) {
            var e = (this.segmentsT + 1) * c + d - 1, f = (this.segmentsT + 1) * (c - 1) + d - 1, g = (this.segmentsT + 1) * (c - 1) + d, h = (this.segmentsT + 1) * c + d, k = new THREE.Face4(e, f, g, h, [b[e], b[f], b[g], b[h]]);
            k.normal.addSelf(b[e]);
            k.normal.addSelf(b[f]);
            k.normal.addSelf(b[g]);
            k.normal.addSelf(b[h]);
            k.normal.normalize();
            this.faces.push(k);
...
THREE.TorusKnotGeometry = function(a, b, c, d, e, f, g) {
    ...
    for (a = 0; a < this.segmentsR; ++a) {
        ...
        for (b = 0; b < this.segmentsT; ++b) {
            var k = a / this.segmentsR * 2 * this.p * Math.PI, g = b / this.segmentsT * 2 * Math.PI, f = h(k, g, this.q, this.p, this.radius, this.heightScale), k = h(k + 0.01, g, this.q, this.p, this.radius, this.heightScale);
            c.sub(k, f);
            d.add(k, f);
            e.cross(c, d);
            d.cross(e, c);
    ...
    for (a = 0; a <
        ...
        for (b = 0; b < this.segmentsT; ++b) {
            ...
            this.faceVertexUvs[0].push([g, k, j, l])
        }
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
...
THREE.TubeGeometry = function(a, b, c, d, e, f) {
    ...
    this.grid = [];
    var g, h, f = this.segments + 1, k, j, l, o = new THREE.Vector3, m, p, q, b = new THREE.TubeGeometry.FrenetFrames(a, b, e);
    m = b.tangents;
    p = b.normals;
    q = b.binormals;
    this.tangents = m;
    ...
    for (b = 0; b < f; b++) {
        ...
        for (d = 0; d < this.segmentsRadius; d++) {
            k = d / this.segmentsRadius * 2 * Math.PI;
            j = -this.radius * Math.cos(k);
            k = this.radius * Math.sin(k);
            o.copy(l);
            o.x = o.x + (j * g.x + k * h.x);
            o.y = o.y + (j * g.y + k * h.y);
            o.z = o.z + (j * g.z + k * h.z);
            this.grid[b][d] = this.vertices.push(new THREE.Vector3(o.x, o.y, o.z)) - 1
        }
    }
    for (b = 0; b < this.segments; b++)
        for (d = 0; d < this.segmentsRadius; d++) {
            f = e ? (b + 1) % this.segments : b + 1;
            o = (d + 1) % this.segmentsRadius;
            a = this.grid[b][d];
            c = this.grid[f][d];
            f = this.grid[f][o];
            o = this.grid[b][o];
            ...
            this.faces.push(new THREE.Face4(a, c, f, o));
            this.faceVertexUvs[0].push([m, p, q, g])
        }
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals()
...
THREE.TubeGeometry.FrenetFrames = function(a, b, c) {
    ...
    new THREE.Vector3;
    var e = [], f = [], g = [], h = new THREE.Vector3, k = new THREE.Matrix4, b = b + 1, j, l, o;
    this.tangents = e;
    this.normals = f;
    this.binormals = g;
    for (j = 0; j < b; j++) {
    ...
    for (j = 1; j < b; j++) {
        ...
        if (h.length() > 1.0E-4) {
            ...
            k.makeRotationAxis(h, d).multiplyVector3(f[j])
        }
        g[j].cross(e[j], f[j])
    }
    if (c) {
        ...
        for (j = 1; j < b; j++) {
            k.makeRotationAxis(e[j], d * j).multiplyVector3(f[j]);
            g[j].cross(e[j], f[j])
        }
    }
};
THREE.PolyhedronGeometry = function(a, b, c, d) {
    ...
    function g(a, b) {
        o[a.index] || (o[a.index] = []);
        o[b.index] || (o[b.index] = []);
        var c = o[a.index][b.index];
        c === void 0 && (o[a.index][b.index] = o[b.index][a.index] = c = e((new THREE.Vector3).add(a, b).divideScalar(2)));
        return c
    }
    function h(a, b, c) {
    ...
    THREE.Geometry.call(this);
    for (var c = c || 1, d = d || 0, k = this, j = 0, l = a.length; j < l; j++)
        e(new THREE.Vector3(a[j][0], a[j][1], a[j][2]));
    for (var o = [], a = this.vertices, j = 0, l = b.length; j < l; j++)
...
THREE.ParametricGeometry = function(a, b, c, d) {
    THREE.Geometry.call(this);
    var e = this.vertices, f = this.faces, g = this.faceVertexUvs[0], d = d === void 0 ? false : d, h, k, j, l, o = b + 1;
    for (h = 0; h <= c; h++) {
        l = h / c;
        for (k = 0; k <= b; k++) {
            j = k / b;
    ...
    for (h = 0; h < c; h++)
        for (k = 0; k < b; k++) {
            ...
            l = (h + 1) * o + k;
            j = (h + 1) * o + k + 1;
            m = new THREE.UV(h / b, k / c);
            p = new THREE.UV(h / b, (k + 1) / c);
            q = new THREE.UV((h + 1) / b, k / c);
            n = new THREE.UV((h + 1) / b, (k + 1) / c);
            if (d) {
...
THREE.SubdivisionModifier.prototype.smooth = function(a) {
    ...
    function d(a, c, d, e, g, h, i) {
        var k = new THREE.Face4(a, c, d, e, null, g.color, g.material);
        if (m.useOldVertexColors) {
            k.vertexColors = [];
            for (var j, n, p, q = 0; q < 4; q++) {
                p = h[q];
                j = new THREE.Color;
                j.setRGB(0, 0, 0);
                for (var r = 0; r < p.length; r++) {
                    n = g.vertexColors[p[r] - 1];
                    j.r = j.r + n.r;
                    j.g = j.g + n.g;
                    j.b = j.b + n.b
                }
        ...
        if (m.supportUVs) {
            ...
            g[0] ? g[1] ? g[2] ? g[3] ? o.push(g) : b("d :( ", e + ":" + i) : b("c :( ", d + ":" + i) : b("b :( ", c + ":" + i) : b("a :( ", a + ":" + i)
        }
    }
    function e(a, b) {
    ...
    var j = [], l = [], o = [], m = this, p = a.vertices, q = a.faces, j = p.concat(), n = [], r = {}, u = {}, t = {}, y = p.length, s, x, G, C, z, v = a.faceVertexUvs[0], A;
    b("originalFaces, uvs, originalVerticesLength", q.length, v.length, y);
    if (m.supportUVs) {
        s = 0;
        for (x = v.length; s < x; s++) {
            G = 0;
            for (C = v[s].length; G < C; G++) {
                A = q[s]["abcd".charAt(G)];
                g(A, s, v[s][G])
            }
        }
    ...
    C = ["123",
        "12", "2", "23"];
    J = ["123", "23", "3", "31"];
    var F = ["123", "31", "1", "12"], i = ["1234", "12", "2", "23"], T = ["1234", "23", "3", "34"], U = ["1234", "34", "4", "41"], D = ["1234", "41", "1", "12"];
    s = 0;
    for (x = n.length; s < x; s++) {
        z = q[s];
        v = y + s;
        if (z instanceof THREE.Face3) {
            A = e(z.a, z.b);
            L = e(z.b, z.c);
            E = e(z.c, z.a);
            d(v, r[A], z.b, r[L], z, C, s);
            d(v, r[L], z.c, r[E], z, J, s);
            d(v, r[E], z.a, r[A], z, F, s)
        } else if (z instanceof THREE.Face4) {
            A = e(z.a, z.b);
            L = e(z.b, z.c);
            E = e(z.c, z.d);
            M = e(z.d, z.a);
            d(v, r[A], z.b, r[L], z, i, s);
            d(v, r[L], z.c, r[E], z, T, s);
            d(v, r[E], z.d, r[M],
                    z, U, s);
            d(v, r[M], z.a, r[A], z, D, s)
        } else
    ...
    for (x = p.length; s < x; s++)
        if (R[s] !== void 0) {
            ...
            A = R[s].length;
            for (G = 0; G < A; G++)
                u[e(R[s][G][0], R[s][G][1])] && C++;
            if (C != 2) {
                r.divideScalar(v);
                for (G = 0; G < A; G++) {
                    v = R[s][G];
                    v = p[v[0]].clone().addSelf(p[v[1]]).divideScalar(2);
                    z.addSelf(v)
                }
                z.divideScalar(A);
                L.addSelf(p[s]);
                L.multiplyScalar(A - 3);
                L.addSelf(r);
                L.addSelf(z.multiplyScalar(2));
                L.divideScalar(A);
                j[s] = L
            }
        }
...
THREE.LensFlarePlugin = function() {
    ...
    this.init = function(q) {
        ...
        o = {};
        m = {};
        o.vertex = b.getAttribLocation(l, "position");
        o.uv = b.getAttribLocation(l, "uv");
    ...
    this.render = function(a, d, e, u) {
        ...
        if (t) {
            var y = new THREE.Vector3, s = u / e, x = e * 0.5, G = u * 0.5, C = 16 / u, z = new THREE.Vector2(C * s, C), v = new THREE.Vector3(1, 1, 0), A = new THREE.Vector2(1, 1), J = m, C = o;
            b.useProgram(l);
            if (!p) {
                b.enableVertexAttribArray(o.vertex);
            ...
            b.uniform1i(J.map,
                    1);
            b.bindBuffer(b.ARRAY_BUFFER, f);
            b.vertexAttribPointer(C.vertex, 2, b.FLOAT, false, 16, 0);
            b.vertexAttribPointer(C.uv, 2, b.FLOAT, false, 16, 8);
            b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, g);
            ...
            for (L = 0; L < t; L++) {
                ...
                z.set(C * s, C);
                E = a[L];
                y.set(E.matrixWorld.elements[12], E.matrixWorld.elements[13], E.matrixWorld.elements[14]);
                d.matrixWorldInverse.multiplyVector3(y);
                d.projectionMatrix.multiplyVector3(y);
                v.copy(y);
                A.x = v.x * x + x;
                A.y = v.y * G + G;
                if (j || A.x > 0 && A.x < e && A.y > 0 &&
                        A.y < u) {
    ...
    this.update = function(k, j) {
                ...
                if (m instanceof THREE.DirectionalLight && m.shadowCascade)
                    for (q = 0; q < m.shadowCascadeCount; q++) {
                        ...
                        if (m.shadowCascadeArray[q])
                            ...
                            n = s.pointsFrustum;
                            for (var x = 0; x < 8; x++) {
                                u[x] = new THREE.Vector3;
                                n[x] = new THREE.Vector3
                            }
        ...
        for (o = y.length; l < o; l++) {
            ...
            if (!m.shadowCamera) {
                ...
                k.add(m.shadowCamera);
                b.autoUpdateScene && k.updateMatrixWorld()
            }
            ...
            if (m.isVirtual && s.originalCamera == j) {
                q = j;
                p = m.shadowCamera;
                n = m.pointsFrustum;
                t = m.pointsWorld;
                ...
                for (r =
                    ...
                    p.matrixWorldInverse.multiplyVector3(u);
                    if (u.x < g.x)
                        g.x = u.x;
                    if (u.x > h.x)
                        h.x = u.x;
            ...
            for (p = t.length; m < p; m++) {
                ...
                if (r.render) {
                    ...
                    r instanceof THREE.BufferGeometry ?
                            b.renderBufferDirect(q, k.__lights, null, u, r, n) : b.renderBuffer(q, k.__lights, null, u, r, n)
                }
            }
            t = k.__webglObjectsImmediate;
            m = 0;
            for (p = t.length; m < p; m++) {
                r = t[m];
                n = r.object;
                if (n.visible && n.castShadow) {
                    n._modelViewMatrix.multiply(q.matrixWorldInverse, n.matrixWorld);
                    b.renderImmediateObject(q, k.__lights, null, c, n)
                }
            }
        }
        l = b.getClearColor();
        o = b.getClearAlpha();
        a.clearColor(l.r, l.g, l.b, o);
        a.enable(a.BLEND);
...
THREE.SpritePlugin = function() {
    ...
    this.init = function(a) {
        ...
        b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
                g);
        b.bufferData(b.ELEMENT_ARRAY_BUFFER, e, b.STATIC_DRAW);
        var a = THREE.ShaderSprite.sprite, m = b.createProgram(), p = b.createShader(b.FRAGMENT_SHADER), q = b.createShader(b.VERTEX_SHADER);
    ...
    this.render = function(d, e, p, q) {
        var d = d.__webglSprites, n = d.length;
        if (n) {
            var r = k, u = j, t = q / p, p = p * 0.5, y = q * 0.5, s = true;
            b.useProgram(h);
            if (!l) {
            ...
            for (r = 0; r < n; r++) {
                ...
                if (x.visible && x.opacity !== 0 && x.map && x.map.image && x.map.image.width) {
                    if (x.useScreenCoordinates) {
                        ...
                        b.uniform3f(u.screenPosition, (x.position.x - p) / p, (y - x.position.y) / y, Math.max(0, Math.min(1, x.position.z)))
                    } else {
                        b.uniform1i(u.useScreenCoordinates, 0);
                        b.uniform1i(u.affectedByDistance, x.affectedByDistance ? 1 : 0);
                        b.uniformMatrix4fv(u.modelViewMatrix, false, x._modelViewMatrix.elements)
                    }
                    e = x.map.image.width / (x.scaleByViewport ? q : 1);
                    G[0] = e * t * x.scale.x;
                    G[1] = e * x.scale.y;
                    b.uniform2f(u.uvScale, x.uvScale.x, x.uvScale.y);
                    b.uniform2f(u.uvOffset, x.uvOffset.x, x.uvOffset.y);
                    b.uniform2f(u.alignment, x.alignment.x, x.alignment.y);
                    b.uniform1f(u.opacity, x.opacity);
                    b.uniform3f(u.color, x.color.r, x.color.g, x.color.b);
                    b.uniform1f(u.rotation, x.rotation);
                    b.uniform2fv(u.scale, G);
                    if (x.mergeWith3D && !s) {
                        b.enable(b.DEPTH_TEST);
                        s = true
                    } else if (!x.mergeWith3D && s) {
                        b.disable(b.DEPTH_TEST);
                        s = false
                    }
    ...
    this.update = function(g, h) {
        ...
        for (j = p.length; k < j; k++) {
            ...
            if (l.render) {
                ...
                l = l.buffer;
                b.setObjectFaces(m);
                o = m.customDepthMaterial ? m.customDepthMaterial : m.geometry.morphTargets.length ? d : c;
                l instanceof
                        THREE.BufferGeometry ? b.renderBufferDirect(h, g.__lights, null, o, l, m) : b.renderBuffer(h, g.__lights, null, o, l, m)
            }
        }
